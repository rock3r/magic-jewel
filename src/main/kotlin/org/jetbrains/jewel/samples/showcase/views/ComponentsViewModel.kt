...
public class ComponentsViewModel(
    ...
    private val views: SnapshotStateList<ViewInfo> =
        mutableStateListOf(
            ...
            ViewInfo(title = "Hypnotoad", iconKey = ShowcaseIcons.Components.hypnotoad, content = { Hypnotoad() }),
    ...
    private var _currentView: ViewInfo by
        mutableStateOf(views.firstOrNull { it.title == System.getProperty("jewel.standalone.initialComponent") }
            ?: views.first())
