...
`parity-native-loaded-font-data-text` enables `MAGIC_JEWEL_LOADED_FONT_DATA_TEXT=true` with native text and requires JBR font-data define markers, proving loaded byte-array fonts take the explicit font-data command path with old/new visual parity.
