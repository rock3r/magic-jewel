...
`commands-vertices-fallback` enables `MAGIC_JEWEL_COMPOSE_VERTICES=true` and asserts `Canvas.drawVertices` remains a structured `vertices` fallback until a dedicated vertices ABI exists.
