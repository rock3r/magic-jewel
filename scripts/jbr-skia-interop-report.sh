...
Environment:
  ...
  MAGIC_JEWEL_COMPOSE_BLEND_MODE Enables Plus/Multiply/Screen/Overlay/Darken/Lighten/Difference/Exclusion blend-mode command replay probes. Default: false.
