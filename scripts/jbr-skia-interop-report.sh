...
Environment:
  ...
  MAGIC_JEWEL_COMPOSE_PATH_EFFECT Enables dashed line/rectangle/rounded-rectangle/arbitrary-path plus corner/stamped path-effect command replay probes. Default: false.
