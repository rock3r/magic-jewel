...
case_group_cases() {
  case "$1" in
    ...
    graphics-layer-basic)
      ...
      ;;
    graphics-layer-effects)
      echo "parity-resize-graphics-layer-color-matrix-filter parity-forced-context-graphics-layer-color-matrix-filter parity-resize-graphics-layer-render-effect parity-forced-context-graphics-layer-render-effect parity-graphics-layer-offset-effect parity-graphics-layer-chained-render-effect parity-graphics-layer-render-effect-color-filter parity-resize-graphics-layer-render-effect-color-filter parity-forced-context-graphics-layer-render-effect-color-filter parity-graphics-layer-render-effect-blend-mode parity-resize-graphics-layer-render-effect-blend-mode parity-forced-context-graphics-layer-render-effect-blend-mode parity-graphics-layer-render-effect-color-matrix-filter parity-graphics-layer-render-effect-blend-color-filter parity-graphics-layer-render-effect-blend-color-matrix-filter parity-graphics-layer-offset-effect-blend-color-matrix-filter parity-graphics-layer-chained-render-effect-blend-color-matrix-filter parity-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter"
      ;;
    graphics-layer-clip-shadow-transform)
