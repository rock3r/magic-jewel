...
case_group_cases() {
  case "$1" in
    ...
    native-text)
      ...
      ;;
    descriptor-lifecycle)
      echo "parity-color-filter-handle parity-resize-color-filter-handle parity-forced-context-color-filter-handle parity-color-matrix-filter parity-resize-color-matrix-filter parity-forced-context-color-matrix-filter parity-lighting-filter parity-descriptor-eviction"
      ;;
    shader-rendering)
