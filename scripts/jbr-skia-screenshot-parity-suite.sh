...
case_group_cases() {
  case "$1" in
    ...
    runtime-effect)
      ...
      ;;
    graphics-layer-basic)
      echo "parity-graphics-layer parity-resize-graphics-layer parity-forced-context-graphics-layer parity-graphics-layer-effects parity-graphics-layer-blend-mode parity-resize-graphics-layer-blend-mode parity-forced-context-graphics-layer-blend-mode parity-graphics-layer-color-filter parity-graphics-layer-color-matrix-filter parity-graphics-layer-blend-color-filter parity-graphics-layer-blend-color-matrix-filter"
      ;;
    graphics-layer-effects)
