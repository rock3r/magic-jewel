...
if [[ "${LIST_CASE_GROUPS}" != "true" && "${LIST_CASE_GROUP_COUNTS}" != "true" && "${LIST_CASES}" != "true" && "${LIST_CASE_COUNT}" != "true" && "${LIST_UNGROUPED_CASES}" != "true" && -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" && -z "${CASES_FROM}" && -z "${CASES_UNTIL}" ]]; then
  jbr_skia_daily_broad_validation_guard "screenshot parity suite (default launch)"
  EARLY_DEFAULT_BROAD_VALIDATION_GUARDED=true
fi
if [[ -z "${CASES_WAS_SET}" && -n "${CASE_GROUPS}" ]]; then
  CASES="__CASE_GROUPS_SELECTED__"
fi
CASES="${CASES:-parity-rich parity-button-chrome parity-geometry-clean parity-skew-transform parity-resize-skew-transform parity-forced-context-skew-transform parity-vertices parity-resize-vertices parity-forced-context-vertices parity-save-layer-filter parity-native-custom-font-text-image parity-native-generic-font-text parity-native-loaded-font-data-text parity-native-resource-font-text parity-native-system-font-text parity-resize-native-generic-font-text parity-resize-native-loaded-font-data-text parity-resize-native-resource-font-text parity-resize-native-system-font-text parity-forced-context-native-custom-font-text-image parity-forced-context-native-generic-font-text parity-forced-context-native-loaded-font-data-text parity-forced-context-native-resource-font-text parity-forced-context-native-system-font-text parity-forced-context-image-refs parity-point-dots parity-resize-point-dots parity-forced-context-point-dots parity-path-effect parity-resize-path-effect parity-forced-context-path-effect parity-draw-shapes parity-clip-rects parity-clip-path parity-blend-modes parity-resize-blend-modes parity-forced-context-blend-modes parity-gradient-surfaces parity-resize-gradient-surfaces parity-forced-context-gradient-surfaces parity-gradient-paths parity-resize-gradient-paths parity-forced-context-gradient-paths parity-gradient-shaders parity-resize-gradient-shaders parity-forced-context-gradient-shaders parity-gradient-stroke parity-resize-gradient-stroke parity-forced-context-gradient-stroke parity-image-filter parity-resize-image-filter parity-forced-context-image-filter parity-image-color-matrix-filter parity-resize-image-color-matrix-filter parity-forced-context-image-color-matrix-filter parity-color-filter-handle parity-resize-color-filter-handle parity-forced-context-color-filter-handle parity-color-matrix-filter parity-resize-color-matrix-filter parity-forced-context-color-matrix-filter parity-lighting-filter parity-resize-lighting-filter parity-forced-context-lighting-filter parity-descriptor-eviction parity-image-shader parity-resize-image-shader parity-forced-context-image-shader parity-color-shader parity-resize-color-shader parity-forced-context-color-shader parity-noise-shader parity-resize-noise-shader parity-forced-context-noise-shader parity-turbulence-shader parity-resize-turbulence-shader parity-forced-context-turbulence-shader parity-image-shader-color-filter parity-resize-image-shader-color-filter parity-forced-context-image-shader-color-filter parity-composite-shader parity-resize-composite-shader parity-forced-context-composite-shader parity-composite-noise-shader parity-resize-composite-noise-shader parity-forced-context-composite-noise-shader parity-composite-shader-color-filter parity-resize-composite-shader-color-filter parity-forced-context-composite-shader-color-filter parity-linear-gradient-shader-color-filter parity-resize-linear-gradient-shader-color-filter parity-forced-context-linear-gradient-shader-color-filter parity-resize-radial-gradient-shader-color-filter parity-forced-context-radial-gradient-shader-color-filter parity-resize-sweep-gradient-shader-color-filter parity-forced-context-sweep-gradient-shader-color-filter parity-transformed-shader parity-resize-transformed-shader parity-forced-context-transformed-shader parity-runtime-effect-pure-color parity-resize-runtime-effect-pure-color parity-forced-context-runtime-effect-pure-color parity-runtime-effect-uniform-only parity-resize-runtime-effect-uniform-only parity-forced-context-runtime-effect-uniform-only parity-runtime-effect-child-only parity-resize-runtime-effect-child-only parity-forced-context-runtime-effect-child-only parity-runtime-effect-shader-source-cache-eviction parity-runtime-effect-shader parity-resize-runtime-effect-shader parity-forced-context-runtime-effect-shader parity-runtime-effect-shader-color-filter parity-resize-runtime-effect-shader-color-filter parity-forced-context-runtime-effect-shader-color-filter parity-runtime-effect-color-filter parity-resize-runtime-effect-color-filter parity-forced-context-runtime-effect-color-filter parity-runtime-effect-stable-color-filter parity-resize-runtime-effect-stable-color-filter parity-forced-context-runtime-effect-stable-color-filter parity-runtime-effect-color-filter-child parity-resize-runtime-effect-color-filter-child parity-forced-context-runtime-effect-color-filter-child parity-runtime-effect-source-cache-eviction parity-graphics-layer parity-resize-graphics-layer parity-forced-context-graphics-layer parity-graphics-layer-effects parity-graphics-layer-blend-mode parity-resize-graphics-layer-blend-mode parity-forced-context-graphics-layer-blend-mode parity-graphics-layer-color-filter parity-resize-graphics-layer-color-filter parity-forced-context-graphics-layer-color-filter parity-graphics-layer-color-matrix-filter parity-graphics-layer-blend-color-filter parity-resize-graphics-layer-blend-color-filter parity-forced-context-graphics-layer-blend-color-filter parity-graphics-layer-blend-color-matrix-filter parity-resize-graphics-layer-blend-color-matrix-filter parity-forced-context-graphics-layer-blend-color-matrix-filter parity-resize-graphics-layer-color-matrix-filter parity-forced-context-graphics-layer-color-matrix-filter parity-resize-graphics-layer-render-effect parity-forced-context-graphics-layer-render-effect parity-graphics-layer-offset-effect parity-resize-graphics-layer-offset-effect parity-forced-context-graphics-layer-offset-effect parity-graphics-layer-chained-render-effect parity-resize-graphics-layer-chained-render-effect parity-forced-context-graphics-layer-chained-render-effect parity-graphics-layer-render-effect-color-filter parity-resize-graphics-layer-render-effect-color-filter parity-forced-context-graphics-layer-render-effect-color-filter parity-graphics-layer-render-effect-blend-mode parity-resize-graphics-layer-render-effect-blend-mode parity-forced-context-graphics-layer-render-effect-blend-mode parity-graphics-layer-render-effect-color-matrix-filter parity-resize-graphics-layer-render-effect-color-matrix-filter parity-forced-context-graphics-layer-render-effect-color-matrix-filter parity-graphics-layer-render-effect-blend-color-filter parity-resize-graphics-layer-render-effect-blend-color-filter parity-forced-context-graphics-layer-render-effect-blend-color-filter parity-graphics-layer-render-effect-blend-color-matrix-filter parity-resize-graphics-layer-render-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-render-effect-blend-color-matrix-filter parity-graphics-layer-offset-effect-blend-color-matrix-filter parity-resize-graphics-layer-offset-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-offset-effect-blend-color-matrix-filter parity-graphics-layer-chained-render-effect-blend-color-matrix-filter parity-resize-graphics-layer-chained-render-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-chained-render-effect-blend-color-matrix-filter parity-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter parity-resize-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter parity-graphics-layer-clip parity-resize-graphics-layer-clip parity-forced-context-graphics-layer-clip parity-graphics-layer-round-clip parity-resize-graphics-layer-round-clip parity-forced-context-graphics-layer-round-clip parity-graphics-layer-path-clip parity-resize-graphics-layer-path-clip parity-forced-context-graphics-layer-path-clip parity-graphics-layer-shadow parity-resize-graphics-layer-shadow parity-forced-context-graphics-layer-shadow parity-graphics-layer-round-shadow parity-resize-graphics-layer-round-shadow parity-forced-context-graphics-layer-round-shadow parity-graphics-layer-path-shadow parity-resize-graphics-layer-path-shadow parity-forced-context-graphics-layer-path-shadow parity-graphics-layer-modulate-alpha parity-resize-graphics-layer-modulate-alpha parity-forced-context-graphics-layer-modulate-alpha parity-graphics-layer-offscreen parity-resize-graphics-layer-offscreen parity-forced-context-graphics-layer-offscreen parity-graphics-layer-rotationx parity-resize-graphics-layer-rotationx parity-forced-context-graphics-layer-rotationx parity-graphics-layer-rotationy parity-resize-graphics-layer-rotationy parity-forced-context-graphics-layer-rotationy parity-graphics-layer-rotationxy parity-resize-graphics-layer-rotationxy parity-forced-context-graphics-layer-rotationxy parity-graphics-layer-scale-translate parity-resize-graphics-layer-scale-translate parity-forced-context-graphics-layer-scale-translate parity-graphics-layer-near-camera parity-resize-graphics-layer-near-camera parity-forced-context-graphics-layer-near-camera parity-graphics-layer-offcenter-pivot parity-resize-graphics-layer-offcenter-pivot parity-forced-context-graphics-layer-offcenter-pivot}"
...
case_group_cases() {
  case "$1" in
    smoke)
      ...
      ;;
    core-drawing)
      echo "parity-skew-transform parity-resize-skew-transform parity-forced-context-skew-transform parity-vertices parity-resize-vertices parity-forced-context-vertices parity-save-layer-filter parity-forced-context-image-refs parity-point-dots parity-resize-point-dots parity-forced-context-point-dots parity-path-effect parity-resize-path-effect parity-forced-context-path-effect parity-draw-shapes parity-clip-rects parity-clip-path parity-blend-modes parity-resize-blend-modes parity-forced-context-blend-modes parity-gradient-surfaces parity-resize-gradient-surfaces parity-forced-context-gradient-surfaces parity-gradient-paths parity-resize-gradient-paths parity-forced-context-gradient-paths parity-gradient-shaders parity-resize-gradient-shaders parity-forced-context-gradient-shaders parity-gradient-stroke parity-resize-gradient-stroke parity-forced-context-gradient-stroke parity-image-filter parity-resize-image-filter parity-forced-context-image-filter parity-image-color-matrix-filter parity-resize-image-color-matrix-filter parity-forced-context-image-color-matrix-filter"
      ;;
    native-text)
      ...
      ;;
    descriptor-lifecycle)
      echo "parity-color-filter-handle parity-resize-color-filter-handle parity-forced-context-color-filter-handle parity-color-matrix-filter parity-resize-color-matrix-filter parity-forced-context-color-matrix-filter parity-lighting-filter parity-resize-lighting-filter parity-forced-context-lighting-filter parity-descriptor-eviction"
      ;;
    shader-rendering)
      echo "parity-image-shader parity-resize-image-shader parity-forced-context-image-shader parity-color-shader parity-resize-color-shader parity-forced-context-color-shader parity-noise-shader parity-resize-noise-shader parity-forced-context-noise-shader parity-turbulence-shader parity-resize-turbulence-shader parity-forced-context-turbulence-shader parity-image-shader-color-filter parity-resize-image-shader-color-filter parity-forced-context-image-shader-color-filter parity-composite-shader parity-resize-composite-shader parity-forced-context-composite-shader parity-composite-noise-shader parity-resize-composite-noise-shader parity-forced-context-composite-noise-shader parity-composite-shader-color-filter parity-resize-composite-shader-color-filter parity-forced-context-composite-shader-color-filter parity-linear-gradient-shader-color-filter parity-resize-linear-gradient-shader-color-filter parity-forced-context-linear-gradient-shader-color-filter parity-resize-radial-gradient-shader-color-filter parity-forced-context-radial-gradient-shader-color-filter parity-resize-sweep-gradient-shader-color-filter parity-forced-context-sweep-gradient-shader-color-filter parity-transformed-shader parity-resize-transformed-shader parity-forced-context-transformed-shader"
      ;;
    runtime-effect)
      echo "parity-runtime-effect-pure-color parity-resize-runtime-effect-pure-color parity-forced-context-runtime-effect-pure-color parity-runtime-effect-uniform-only parity-resize-runtime-effect-uniform-only parity-forced-context-runtime-effect-uniform-only parity-runtime-effect-child-only parity-resize-runtime-effect-child-only parity-forced-context-runtime-effect-child-only parity-runtime-effect-shader-source-cache-eviction parity-runtime-effect-shader parity-resize-runtime-effect-shader parity-forced-context-runtime-effect-shader parity-runtime-effect-shader-color-filter parity-resize-runtime-effect-shader-color-filter parity-forced-context-runtime-effect-shader-color-filter parity-runtime-effect-color-filter parity-resize-runtime-effect-color-filter parity-forced-context-runtime-effect-color-filter parity-runtime-effect-stable-color-filter parity-resize-runtime-effect-stable-color-filter parity-forced-context-runtime-effect-stable-color-filter parity-runtime-effect-color-filter-child parity-resize-runtime-effect-color-filter-child parity-forced-context-runtime-effect-color-filter-child parity-runtime-effect-source-cache-eviction"
      ;;
    graphics-layer-basic)
      echo "parity-graphics-layer parity-resize-graphics-layer parity-forced-context-graphics-layer parity-graphics-layer-effects parity-graphics-layer-blend-mode parity-resize-graphics-layer-blend-mode parity-forced-context-graphics-layer-blend-mode parity-graphics-layer-color-filter parity-resize-graphics-layer-color-filter parity-forced-context-graphics-layer-color-filter parity-graphics-layer-color-matrix-filter parity-graphics-layer-blend-color-filter parity-resize-graphics-layer-blend-color-filter parity-forced-context-graphics-layer-blend-color-filter parity-graphics-layer-blend-color-matrix-filter parity-resize-graphics-layer-blend-color-matrix-filter parity-forced-context-graphics-layer-blend-color-matrix-filter"
      ;;
    graphics-layer-effects)
      echo "parity-resize-graphics-layer-color-matrix-filter parity-forced-context-graphics-layer-color-matrix-filter parity-resize-graphics-layer-render-effect parity-forced-context-graphics-layer-render-effect parity-graphics-layer-offset-effect parity-resize-graphics-layer-offset-effect parity-forced-context-graphics-layer-offset-effect parity-graphics-layer-chained-render-effect parity-resize-graphics-layer-chained-render-effect parity-forced-context-graphics-layer-chained-render-effect parity-graphics-layer-render-effect-color-filter parity-resize-graphics-layer-render-effect-color-filter parity-forced-context-graphics-layer-render-effect-color-filter parity-graphics-layer-render-effect-blend-mode parity-resize-graphics-layer-render-effect-blend-mode parity-forced-context-graphics-layer-render-effect-blend-mode parity-graphics-layer-render-effect-color-matrix-filter parity-resize-graphics-layer-render-effect-color-matrix-filter parity-forced-context-graphics-layer-render-effect-color-matrix-filter parity-graphics-layer-render-effect-blend-color-filter parity-resize-graphics-layer-render-effect-blend-color-filter parity-forced-context-graphics-layer-render-effect-blend-color-filter parity-graphics-layer-render-effect-blend-color-matrix-filter parity-resize-graphics-layer-render-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-render-effect-blend-color-matrix-filter parity-graphics-layer-offset-effect-blend-color-matrix-filter parity-resize-graphics-layer-offset-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-offset-effect-blend-color-matrix-filter parity-graphics-layer-chained-render-effect-blend-color-matrix-filter parity-resize-graphics-layer-chained-render-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-chained-render-effect-blend-color-matrix-filter parity-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter parity-resize-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter parity-forced-context-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter"
      ;;
    graphics-layer-clip-shadow-transform)
      echo "parity-graphics-layer-clip parity-resize-graphics-layer-clip parity-forced-context-graphics-layer-clip parity-graphics-layer-round-clip parity-resize-graphics-layer-round-clip parity-forced-context-graphics-layer-round-clip parity-graphics-layer-path-clip parity-resize-graphics-layer-path-clip parity-forced-context-graphics-layer-path-clip parity-graphics-layer-shadow parity-resize-graphics-layer-shadow parity-forced-context-graphics-layer-shadow parity-graphics-layer-round-shadow parity-resize-graphics-layer-round-shadow parity-forced-context-graphics-layer-round-shadow parity-graphics-layer-path-shadow parity-resize-graphics-layer-path-shadow parity-forced-context-graphics-layer-path-shadow parity-graphics-layer-modulate-alpha parity-resize-graphics-layer-modulate-alpha parity-forced-context-graphics-layer-modulate-alpha parity-graphics-layer-offscreen parity-resize-graphics-layer-offscreen parity-forced-context-graphics-layer-offscreen parity-graphics-layer-rotationx parity-resize-graphics-layer-rotationx parity-forced-context-graphics-layer-rotationx parity-graphics-layer-rotationy parity-resize-graphics-layer-rotationy parity-forced-context-graphics-layer-rotationy parity-graphics-layer-rotationxy parity-resize-graphics-layer-rotationxy parity-forced-context-graphics-layer-rotationxy parity-graphics-layer-scale-translate parity-resize-graphics-layer-scale-translate parity-forced-context-graphics-layer-scale-translate parity-graphics-layer-near-camera parity-resize-graphics-layer-near-camera parity-forced-context-graphics-layer-near-camera parity-graphics-layer-offcenter-pivot parity-resize-graphics-layer-offcenter-pivot parity-forced-context-graphics-layer-offcenter-pivot"
      ;;
    *)
  ...
  case "$1" in
    ...
    parity-geometry-clean)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=40 \
        EXPECT_MIN_IMAGE_REFS=0
      ;;
    parity-skew-transform)
      run_case "$1" \
        ...
        EXPECT_MIN_IMAGE_REFS=0 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=14 \
        MAX_BAD_PIXEL_RATIO=0.08 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.11 \
        MAX_COMPOSE_BOTTOM_SWATCHES_BAD_PIXEL_RATIO=0.005
      ;;
    parity-resize-skew-transform)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=22 \
        MAX_BAD_PIXEL_RATIO=0.08 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.11 \
        MAX_COMPOSE_BOTTOM_SWATCHES_BAD_PIXEL_RATIO=0.005 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
        MAX_SWING_ISLAND_BAD_PIXEL_RATIO=0.04
      ;;
    parity-forced-context-skew-transform)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
        ...
        EXPECT_MIN_JBR_SCOPED_IMAGE_CACHE_CLEARS=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=64 \
        MAX_BAD_PIXEL_RATIO=0.08 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.11 \
        MAX_COMPOSE_BOTTOM_SWATCHES_BAD_PIXEL_RATIO=0.005 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
    ...
    parity-vertices)
      run_case "$1" \
        ...
        EXPECT_MIN_IMAGE_REFS=0 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=9 \
        MAX_BAD_PIXEL_RATIO=0.08 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.11
      ;;
    parity-resize-vertices)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_VERTICES=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-vertices)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_VERTICES=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-forced-context-native-generic-font-text)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_SCOPED_IMAGE_CACHE_CLEARS=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=56 \
        MAX_BAD_PIXEL_RATIO=0.07 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.10 \
        MAX_COMPOSE_BOTTOM_LABELS_BAD_PIXEL_RATIO=0.18 \
        MAX_COMPOSE_PARAGRAPH_PROBES_BAD_PIXEL_RATIO=0.20
    ...
    parity-forced-context-native-loaded-font-data-text)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_SCOPED_IMAGE_CACHE_CLEARS=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=33 \
        MAX_BAD_PIXEL_RATIO=0.07 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.10 \
        MAX_COMPOSE_BOTTOM_LABELS_BAD_PIXEL_RATIO=0.18
      ;;
    ...
    parity-resize-point-dots)
      run_case "$1" \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-point-dots)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_POINT_DOTS=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-resize-path-effect)
      ...
      ;;
    parity-forced-context-path-effect)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=true \
    ...
    parity-resize-blend-modes)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-forced-context-blend-modes)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=true \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-gradient-surfaces)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-resize-gradient-surfaces)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-forced-context-gradient-surfaces)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
    ...
    parity-resize-gradient-paths)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-forced-context-gradient-paths)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
    ...
    parity-gradient-shaders)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-resize-gradient-shaders)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-forced-context-gradient-shaders)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
    ...
    parity-resize-gradient-stroke)
      run_case "$1" \
        ...
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        MIN_LINEAR_GRADIENT_STROKE_PROBE_RIGHT_ORANGE=300 \
        EXPECT_MIN_SURFACE_CHANGES=1 \
        EXPECT_SURFACE_CONTEXT_CHANGED=false \
        EXPECT_SURFACE_CHANGED=true \
        EXPECT_MIN_COMMAND_CACHE_CLEARS=1 \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.06
      ;;
    parity-forced-context-gradient-stroke)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
    ...
    parity-resize-image-filter)
      run_case "$1" \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-image-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_IMAGE_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-image-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.06
      ;;
    parity-resize-image-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_IMAGE_COLOR_MATRIX_FILTER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.06
      ;;
    parity-forced-context-image-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_IMAGE_COLOR_MATRIX_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-color-filter-handle)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=8 \
        MAX_BAD_PIXEL_RATIO=0.06
      ;;
    ...
    parity-forced-context-color-filter-handle)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=11 \
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.06
      ;;
    parity-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.06
      ;;
    parity-resize-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        MAGIC_JEWEL_COMPOSE_DRAW_PATH=false \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.06
      ;;
    parity-forced-context-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        MAGIC_JEWEL_COMPOSE_DRAW_PATH=false \
    ...
    parity-resize-lighting-filter)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=16 \
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.06
      ;;
    parity-forced-context-lighting-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        MAGIC_JEWEL_COMPOSE_DRAW_PATH=false \
    ...
    parity-resize-image-shader)
      run_case "$1" \
        ...
        MAX_COMPOSE_SHADER_IMAGE_BAD_PIXEL_RATIO=0.07
      ;;
    parity-forced-context-image-shader)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
    ...
    parity-resize-color-shader)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_SHADER_HANDLE_USES=1 \
        EXPECT_MIN_JBR_SHADER_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=8 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=48 \
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
    ...
    parity-image-shader-color-filter)
      ...
      ;;
    parity-resize-image-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_IMAGE_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=2 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=32 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=48 \
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
        MAX_COMPOSE_SHADER_IMAGE_BAD_PIXEL_RATIO=0.08
      ;;
    parity-forced-context-image-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_IMAGE_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=2 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=40 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=56 \
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_COMPOSE_SHADER_IMAGE_BAD_PIXEL_RATIO=0.08
      ;;
    parity-composite-shader)
      run_case "$1" \
        ...
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=24 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=40 \
        MAX_BAD_PIXEL_RATIO=0.08 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.11 \
      ...
      ;;
    parity-resize-composite-shader)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
        ...
        EXPECT_MIN_JBR_SHADER_HANDLE_USES=1 \
        EXPECT_MIN_JBR_SHADER_HANDLE_CACHE_HITS=3 \
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=48 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=48 \
        MAX_BAD_PIXEL_RATIO=0.08 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
        ...
        MAX_COMPOSE_SHADER_COMPOSITE_BAD_PIXEL_RATIO=0.09
      ;;
    parity-forced-context-composite-shader)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TEXT=false \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        MAGIC_JEWEL_PARAGRAPH_LAYOUT_TEXT=false \
        ...
        EXPECT_MIN_JBR_SHADER_HANDLE_USES=1 \
        EXPECT_MIN_JBR_SHADER_HANDLE_CACHE_HITS=3 \
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=56 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=56 \
        MAX_BAD_PIXEL_RATIO=0.08 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.11 \
    ...
    parity-composite-noise-shader)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_SHADER_HANDLE_USES=1 \
        EXPECT_MIN_JBR_SHADER_HANDLE_CACHE_HITS=3 \
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=16 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=32 \
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_COMPOSE_SHADER_COMPOSITE_BAD_PIXEL_RATIO=0.09
    ...
    parity-composite-shader-color-filter)
      ...
      ;;
    parity-resize-composite-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_COMPOSITE_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_COMPOSE_SHADER_COMPOSITE_BAD_PIXEL_RATIO=0.09
      ;;
    parity-forced-context-composite-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_COMPOSITE_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-linear-gradient-shader-color-filter)
      ...
      ;;
    parity-resize-linear-gradient-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_LINEAR_GRADIENT_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03 \
        MAX_COMPOSE_SHADER_LINEAR_BAD_PIXEL_RATIO=0.07
      ;;
    parity-forced-context-linear-gradient-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_LINEAR_GRADIENT_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        ...
        MAX_COMPOSE_SHADER_LINEAR_BAD_PIXEL_RATIO=0.07
      ;;
    parity-resize-radial-gradient-shader-color-filter)
      run_case "$1" \
        ...
        MAX_COMPOSE_SHADER_LINEAR_BAD_PIXEL_RATIO=0.07
      ;;
    parity-forced-context-radial-gradient-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RADIAL_GRADIENT_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        ...
        MAX_COMPOSE_SHADER_LINEAR_BAD_PIXEL_RATIO=0.07
      ;;
    parity-resize-sweep-gradient-shader-color-filter)
      run_case "$1" \
        ...
        MAX_COMPOSE_SHADER_LINEAR_BAD_PIXEL_RATIO=0.07
      ;;
    parity-forced-context-sweep-gradient-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_SWEEP_GRADIENT_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-transformed-shader)
      ...
      ;;
    parity-resize-transformed-shader)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TRANSFORMED_SHADER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.11
      ;;
    parity-forced-context-transformed-shader)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_TRANSFORMED_SHADER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-runtime-effect-uniform-only)
      run_case "$1" \
        ...
        MAX_BAD_PIXEL_RATIO=0.06
      ;;
    parity-resize-runtime-effect-uniform-only)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_UNIFORM_ONLY=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-runtime-effect-uniform-only)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_UNIFORM_ONLY=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-runtime-effect-child-only)
      run_case "$1" \
        ...
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=32
      ;;
    parity-resize-runtime-effect-child-only)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_CHILD_ONLY=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-runtime-effect-child-only)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_CHILD_ONLY=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-runtime-effect-shader)
      run_case "$1" \
        ...
        EXPECT_MAX_JBR_RUNTIME_EFFECT_CACHE_MISSES=1
      ;;
    parity-resize-runtime-effect-shader)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_SHADER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-runtime-effect-shader)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_SHADER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-runtime-effect-shader-color-filter)
      run_case "$1" \
        ...
        MAX_BAD_PIXEL_RATIO=0.06
      ;;
    parity-resize-runtime-effect-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=2 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=80 \
        EXPECT_MIN_JBR_RUNTIME_EFFECT_CACHE_HITS=1 \
        EXPECT_MAX_JBR_RUNTIME_EFFECT_CACHE_MISSES=1 \
        MAX_BAD_PIXEL_RATIO=0.06 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-runtime-effect-shader-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_SHADER_COLOR_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_DEFINES=2 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=96 \
        EXPECT_MIN_JBR_RUNTIME_EFFECT_CACHE_HITS=1 \
        EXPECT_MAX_JBR_RUNTIME_EFFECT_CACHE_MISSES=1 \
        MAX_BAD_PIXEL_RATIO=0.06
      ;;
    parity-runtime-effect-color-filter)
      run_case "$1" \
        ...
        EXPECT_MAX_JBR_RUNTIME_EFFECT_CACHE_MISSES=1
      ;;
    parity-resize-runtime-effect-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_COLOR_FILTER=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-runtime-effect-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_COLOR_FILTER=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-forced-context-runtime-effect-stable-color-filter)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=72 \
        EXPECT_MIN_JBR_RUNTIME_EFFECT_CACHE_HITS=1 \
        EXPECT_MAX_JBR_RUNTIME_EFFECT_CACHE_MISSES=1 \
        MAX_BAD_PIXEL_RATIO=0.06
      ;;
    parity-runtime-effect-color-filter-child)
      run_case "$1" \
        ...
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=32
      ;;
    parity-resize-runtime-effect-color-filter-child)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_COLOR_FILTER_CHILD=true \
        MAGIC_JEWEL_AUTO_RESIZE=true \
        MAGIC_JEWEL_AUTO_RESIZE_DELAY_MILLIS=500 \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-runtime-effect-color-filter-child)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_RUNTIME_EFFECT_COLOR_FILTER_CHILD=true \
        MAGIC_JEWEL_FORCE_CONTEXT_CHANGE=true \
        MAGIC_JEWEL_UNSUPPORTED_TEXT=false \
    ...
    parity-resize-graphics-layer)
      run_case "$1" \
        ...
        EXPECT_MIN_JBR_IMAGE_CACHE_CLEARS=1 \
        EXPECT_MIN_JBR_SCOPED_IMAGE_CACHE_CLEARS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=0 \
        EXPECT_MAX_JBR_SHADER_HANDLE_DEFINES=0 \
        MAX_BAD_PIXEL_RATIO=0.09 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.12 \
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-blend-mode)
      ...
      ;;
    parity-resize-graphics-layer-blend-mode)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-blend-mode)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-color-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-blend-color-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-blend-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-blend-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-blend-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-render-effect-color-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-render-effect-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=7 \
        MAX_BAD_PIXEL_RATIO=0.09 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.12 \
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-render-effect-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-render-effect-blend-mode)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-render-effect-blend-mode)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-render-effect-blend-mode)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-render-effect-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-render-effect-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-render-effect-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=20 \
        MAX_BAD_PIXEL_RATIO=0.09 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.12 \
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
    ...
    parity-graphics-layer-offset-effect)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-offset-effect)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-offset-effect)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-chained-render-effect)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-chained-render-effect)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-chained-render-effect)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-render-effect-blend-color-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-render-effect-blend-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-render-effect-blend-color-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-offset-effect-blend-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-offset-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-offset-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-chained-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-chained-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=21 \
        MAX_BAD_PIXEL_RATIO=0.09 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.12 \
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-chained-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16
      ;;
    parity-resize-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        EXPECT_MIN_JBR_EFFECT_HANDLE_USES=1 \
        EXPECT_MIN_JBR_EFFECT_HANDLE_CACHE_HITS=1 \
        EXPECT_MAX_JBR_EFFECT_HANDLE_DEFINES=30 \
        MAX_BAD_PIXEL_RATIO=0.10 \
        MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO=0.13 \
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.16 \
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
    ...
    parity-graphics-layer-clip)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-clip)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-clip)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-round-clip)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-round-clip)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-round-clip)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-path-clip)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-path-clip)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-path-clip)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-shadow)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-resize-graphics-layer-shadow)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-shadow)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-round-shadow)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-round-shadow)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-round-shadow)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-path-shadow)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-path-shadow)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-path-shadow)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-offscreen)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.08
      ;;
    parity-resize-graphics-layer-offscreen)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-offscreen)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-modulate-alpha)
      ...
      ;;
    parity-resize-graphics-layer-modulate-alpha)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-modulate-alpha)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-rotationx)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-rotationx)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-rotationx)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-rotationy)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-rotationy)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-rotationxy)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-rotationxy)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-rotationxy)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-scale-translate)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.09
      ;;
    parity-resize-graphics-layer-scale-translate)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-scale-translate)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-near-camera)
      ...
      ;;
    parity-resize-graphics-layer-near-camera)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-near-camera)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
    ...
    parity-graphics-layer-offcenter-pivot)
      run_case "$1" \
        ...
        MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO=0.10
      ;;
    parity-resize-graphics-layer-offcenter-pivot)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
        ...
        MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO=0.03
      ;;
    parity-forced-context-graphics-layer-offcenter-pivot)
      run_case "$1" \
        MAGIC_JEWEL_COMPOSE_BLEND_MODE=false \
        MAGIC_JEWEL_COMPOSE_COLOR_FILTER=false \
        MAGIC_JEWEL_COMPOSE_PATH_EFFECT=false \
