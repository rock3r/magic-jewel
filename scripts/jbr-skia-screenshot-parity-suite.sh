...
case_group_cases() {
  case "$1" in
    ...
    descriptor-lifecycle)
      ...
      ;;
    shader-rendering)
      echo "parity-image-shader parity-color-shader parity-resize-color-shader parity-forced-context-color-shader parity-noise-shader parity-resize-noise-shader parity-forced-context-noise-shader parity-turbulence-shader parity-resize-turbulence-shader parity-forced-context-turbulence-shader parity-image-shader-color-filter parity-composite-shader parity-composite-noise-shader parity-resize-composite-noise-shader parity-forced-context-composite-noise-shader parity-composite-shader-color-filter parity-linear-gradient-shader-color-filter parity-resize-linear-gradient-shader-color-filter parity-forced-context-linear-gradient-shader-color-filter parity-resize-radial-gradient-shader-color-filter parity-forced-context-radial-gradient-shader-color-filter parity-resize-sweep-gradient-shader-color-filter parity-forced-context-sweep-gradient-shader-color-filter parity-transformed-shader"
      ;;
    runtime-effect)
