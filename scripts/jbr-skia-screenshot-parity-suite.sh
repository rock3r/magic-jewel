...
case_group_cases() {
  case "$1" in
    smoke)
      ...
      ;;
    core-drawing)
      echo "parity-skew-transform parity-vertices parity-save-layer-filter parity-forced-context-image-refs parity-point-dots parity-path-effect parity-draw-shapes parity-clip-rects parity-clip-path parity-blend-modes parity-gradient-surfaces parity-gradient-paths parity-gradient-shaders parity-resize-gradient-shaders parity-forced-context-gradient-shaders parity-gradient-stroke parity-image-filter parity-image-color-matrix-filter"
      ;;
    native-text)
