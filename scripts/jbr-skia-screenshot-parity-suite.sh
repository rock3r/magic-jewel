...
case_group_cases() {
  case "$1" in
    ...
    graphics-layer-effects)
      ...
      ;;
    graphics-layer-clip-shadow-transform)
      echo "parity-graphics-layer-clip parity-graphics-layer-round-clip parity-graphics-layer-path-clip parity-graphics-layer-shadow parity-graphics-layer-round-shadow parity-graphics-layer-path-shadow parity-graphics-layer-modulate-alpha parity-resize-graphics-layer-modulate-alpha parity-forced-context-graphics-layer-modulate-alpha parity-graphics-layer-offscreen parity-resize-graphics-layer-offscreen parity-forced-context-graphics-layer-offscreen parity-graphics-layer-rotationx parity-graphics-layer-rotationy parity-graphics-layer-rotationxy parity-graphics-layer-scale-translate parity-graphics-layer-near-camera parity-graphics-layer-offcenter-pivot"
      ;;
    *)
