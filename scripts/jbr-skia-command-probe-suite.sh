...
case_group_cases() {
  case "$1" in
    ...
    primitive-invalid)
      ...
      ;;
    path-invalid)
      echo "commands-invalid-clip-path-verb-fallback commands-invalid-draw-path-verb-fallback commands-invalid-draw-path-path-effect-verb-fallback commands-invalid-stroke-line-dash-path-effect-interval-count-fallback commands-invalid-stroke-rect-dash-path-effect-interval-count-fallback commands-invalid-stroke-rect-dash-path-effect-width-fallback commands-invalid-stroke-rect-dash-path-effect-height-fallback commands-invalid-stroke-round-rect-dash-path-effect-interval-count-fallback commands-invalid-stroke-round-rect-dash-path-effect-right-fallback commands-invalid-stroke-round-rect-dash-path-effect-bottom-fallback commands-invalid-stroke-round-rect-dash-path-effect-radius-x-fallback commands-invalid-stroke-round-rect-dash-path-effect-radius-y-fallback commands-invalid-stroke-round-rect-dash-path-effect-phase-fallback commands-invalid-stroke-round-rect-dash-path-effect-interval-fallback commands-invalid-stroke-path-dash-path-effect-verb-fallback commands-invalid-stroke-path-dash-path-effect-interval-count-fallback commands-invalid-stroke-path-dash-path-effect-interval-fallback commands-invalid-draw-shadow-path-verb-fallback"
      ;;
    effect-descriptor-invalid)
