...
case_group_cases() {
  case "$1" in
    ...
    effect-descriptor-invalid)
      echo "commands-invalid-effect-descriptor-type-fallback commands-invalid-effect-descriptor-version-fallback commands-invalid-effect-descriptor-payload-count-fallback commands-invalid-effect-descriptor-record-length-fallback commands-invalid-tint-color-filter-descriptor-blend-mode-fallback commands-invalid-color-matrix-filter-descriptor-payload-fallback commands-invalid-blur-image-filter-descriptor-sigma-fallback commands-invalid-blur-image-filter-descriptor-tile-mode-fallback commands-invalid-offset-image-filter-descriptor-delta-fallback commands-invalid-corner-path-effect-descriptor-radius-fallback commands-invalid-stamped-path-effect-descriptor-advance-fallback commands-invalid-stamped-path-effect-descriptor-zero-advance-fallback commands-invalid-stamped-path-effect-descriptor-phase-fallback commands-invalid-stamped-path-effect-descriptor-negative-phase-fallback commands-invalid-stamped-path-effect-descriptor-style-fallback commands-invalid-stamped-path-effect-descriptor-fill-type-fallback commands-invalid-stamped-path-effect-descriptor-path-data-length-fallback"
      ;;
...
if [[ -z "${CASES_WAS_SET}" ]]; then
  ...
  CASES="${CASES/commands-invalid-blur-image-filter-descriptor-sigma-fallback commands-invalid-shader-descriptor-type-fallback/commands-invalid-blur-image-filter-descriptor-sigma-fallback commands-invalid-blur-image-filter-descriptor-tile-mode-fallback commands-invalid-shader-descriptor-type-fallback}"
  ...
  CASES="${CASES/commands-invalid-corner-path-effect-descriptor-radius-fallback commands-invalid-shader-descriptor-type-fallback/commands-invalid-corner-path-effect-descriptor-radius-fallback commands-invalid-stamped-path-effect-descriptor-advance-fallback commands-invalid-stamped-path-effect-descriptor-zero-advance-fallback commands-invalid-stamped-path-effect-descriptor-phase-fallback commands-invalid-stamped-path-effect-descriptor-negative-phase-fallback commands-invalid-stamped-path-effect-descriptor-style-fallback commands-invalid-stamped-path-effect-descriptor-fill-type-fallback commands-invalid-stamped-path-effect-descriptor-path-data-length-fallback commands-invalid-shader-descriptor-type-fallback}"
