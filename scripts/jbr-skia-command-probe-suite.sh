...
case_group_cases() {
  case "$1" in
    ...
    save-layer-invalid)
      ...
      ;;
    color-filters)
      echo "commands-image-color-matrix-filter commands-raw-blend-color-filter-fallback commands-raw-table-color-filter-fallback commands-color-filter commands-color-filter-handle commands-color-matrix-filter commands-lighting-filter commands-graphics-layer-color-filter commands-graphics-layer-color-matrix-filter commands-graphics-layer-blend-color-filter commands-graphics-layer-blend-color-matrix-filter"
      ;;
    descriptor-lifecycle)
