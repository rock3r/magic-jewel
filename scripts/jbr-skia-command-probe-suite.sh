...
case_group_cases() {
  case "$1" in
    ...
    shader-descriptor-invalid)
      echo "commands-invalid-shader-descriptor-type-fallback commands-invalid-shader-descriptor-payload-count-fallback commands-invalid-shader-descriptor-record-length-fallback commands-invalid-transformed-shader-descriptor-payload-count-fallback commands-invalid-linear-gradient-shader-descriptor-tile-mode-fallback commands-invalid-radial-gradient-shader-descriptor-radius-fallback commands-invalid-image-shader-descriptor-width-fallback commands-invalid-perlin-noise-shader-kind-fallback commands-invalid-perlin-noise-shader-frequency-fallback commands-invalid-perlin-noise-shader-octaves-fallback commands-invalid-perlin-noise-shader-zero-octaves-fallback commands-invalid-perlin-noise-shader-tile-size-fallback commands-invalid-perlin-noise-shader-negative-tile-size-fallback commands-invalid-descriptor-version-fallback"
      ;;
...
if [[ -z "${CASES_WAS_SET}" ]]; then
  ...
  CASES="${CASES/commands-invalid-transformed-shader-descriptor-payload-count-fallback commands-invalid-descriptor-version-fallback/commands-invalid-transformed-shader-descriptor-payload-count-fallback commands-invalid-linear-gradient-shader-descriptor-tile-mode-fallback commands-invalid-radial-gradient-shader-descriptor-radius-fallback commands-invalid-image-shader-descriptor-width-fallback commands-invalid-perlin-noise-shader-kind-fallback commands-invalid-perlin-noise-shader-frequency-fallback commands-invalid-perlin-noise-shader-octaves-fallback commands-invalid-perlin-noise-shader-zero-octaves-fallback commands-invalid-perlin-noise-shader-tile-size-fallback commands-invalid-perlin-noise-shader-negative-tile-size-fallback commands-invalid-descriptor-version-fallback}"
fi
mkdir -p "${OUT_ROOT}"
