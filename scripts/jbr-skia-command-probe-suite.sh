...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  CASES="${CASES/commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback/commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-save-layer-color-filter-use-fallback commands-invalid-save-layer-blend-color-filter-use-fallback commands-invalid-effect-child-use-after-evict-fallback}"
