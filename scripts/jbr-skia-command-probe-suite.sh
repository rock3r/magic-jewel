...
CASES="${CASES:-commands-live-animation commands-invalid-command-stream-flags-fallback commands-invalid-command-record-flags-fallback commands-invalid-command-coordinate-space-fallback commands-invalid-command-paint-format-fallback commands-invalid-command-payload-length-fallback commands-invalid-command-payload-truncated-fallback commands-invalid-command-payload-extra-fallback commands-invalid-command-record-length-fallback commands-native-bridge-load-library commands-core-primitives commands-point-lines commands-point-dots commands-concat-transform commands-skew-transform commands-gradient-surfaces commands-gradient-paths commands-linear-gradient-path-stroke-fallback commands-radial-gradient-path-stroke-fallback commands-sweep-gradient-path-stroke-fallback commands-popup commands-popup-window commands-menu commands-text-image commands-native-custom-font-text-image commands-native-generic-font-text commands-native-loaded-font-data-text commands-native-resource-font-text commands-native-system-font-text commands-resize-native-generic-font-text commands-resize-native-loaded-font-data-text commands-resize-native-resource-font-text commands-resize-native-system-font-text commands-forced-context-native-custom-font-text-image commands-forced-context-native-generic-font-text commands-forced-context-native-loaded-font-data-text commands-forced-context-native-resource-font-text commands-forced-context-native-system-font-text commands-forced-context-dynamic-images commands-image-path-effect-fallback commands-image-shader commands-raw-image-shader-fallback commands-color-shader commands-descriptor-stroke-shader-fallback commands-gradient-shaders commands-noise-shader commands-turbulence-shader commands-raw-linear-gradient-shader-fallback commands-raw-radial-gradient-shader-fallback commands-raw-sweep-gradient-shader-fallback commands-raw-conical-gradient-shader-fallback commands-raw-noise-shader-fallback commands-raw-turbulence-shader-fallback commands-image-shader-color-filter commands-composite-shader commands-composite-noise-shader commands-composite-shader-color-filter commands-transformed-shader commands-runtime-effect-shader commands-raw-runtime-effect-shader-fallback commands-runtime-effect-shader-color-filter commands-linear-gradient-shader-color-filter commands-runtime-effect-pure-color commands-runtime-effect-uniform-only commands-runtime-effect-child-only commands-runtime-effect-shader-source-cache-eviction commands-runtime-effect-invalid-uniform-schema-fallback commands-runtime-effect-invalid-child-schema-fallback commands-runtime-effect-invalid-nested-child-fallback commands-runtime-effect-color-filter commands-runtime-effect-stable-color-filter commands-resize-runtime-effect-stable-color-filter commands-forced-context-runtime-effect-stable-color-filter commands-raw-runtime-effect-color-filter-fallback commands-runtime-effect-color-filter-child commands-runtime-effect-source-cache-eviction commands-runtime-effect-color-filter-invalid-uniform-schema-fallback commands-runtime-effect-color-filter-invalid-child-schema-fallback commands-runtime-effect-color-filter-invalid-nested-child-fallback commands-runtime-effect-color-filter-compile-fallback commands-runtime-effect-color-filter-build-fallback commands-runtime-effect-color-filter-child-type-fallback commands-runtime-effect-compile-fallback commands-runtime-effect-build-fallback commands-runtime-effect-child-type-fallback commands-invalid-descriptor-use-fallback commands-invalid-shader-descriptor-use-fallback commands-invalid-descriptor-use-after-evict-fallback commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback commands-invalid-path-effect-child-use-after-evict-fallback commands-runtime-effect-color-filter-child-missing-fallback commands-offset-image-filter-child-missing-fallback commands-chain-path-effect-child-missing-fallback commands-shader-color-filter-effect-child-missing-fallback commands-invalid-shader-descriptor-type-fallback commands-invalid-descriptor-version-fallback commands-shader-wrong-effect-type-fallback commands-transformed-shader-child-wrong-effect-type-fallback commands-composite-shader-child-wrong-effect-type-fallback commands-composite-shader-src-child-wrong-effect-type-fallback commands-runtime-effect-shader-child-wrong-effect-type-fallback commands-transformed-shader-child-missing-fallback commands-composite-shader-child-missing-fallback commands-composite-shader-src-child-missing-fallback commands-shader-color-filter-shader-child-missing-fallback commands-color-filter-wrong-effect-type-fallback commands-runtime-effect-color-filter-child-wrong-effect-type-fallback commands-runtime-effect-color-filter-child-path-effect-wrong-type-fallback commands-color-filter-path-effect-wrong-type-fallback commands-shader-color-filter-wrong-effect-type-fallback commands-image-filter-wrong-effect-type-fallback commands-offset-image-filter-child-wrong-effect-type-fallback commands-chain-path-effect-child-wrong-effect-type-fallback commands-gradient-stroke commands-image-filter commands-image-color-matrix-filter commands-image-raw-table-color-filter-fallback commands-raw-blend-color-filter-fallback commands-raw-table-color-filter-fallback commands-color-filter commands-color-filter-blend-mode commands-color-filter-handle commands-color-matrix-filter commands-lighting-filter commands-descriptor-eviction commands-resize-descriptor-redefine commands-forced-context-descriptor-redefine commands-resize-shader-descriptor-redefine commands-forced-context-shader-descriptor-redefine commands-resize-color-shader-descriptor-redefine commands-forced-context-color-shader-descriptor-redefine commands-resize-noise-shader-descriptor-redefine commands-forced-context-noise-shader-descriptor-redefine commands-resize-turbulence-shader-descriptor-redefine commands-forced-context-turbulence-shader-descriptor-redefine commands-resize-composite-noise-shader-descriptor-redefine commands-forced-context-composite-noise-shader-descriptor-redefine commands-path-effect commands-path-effect-color-filter-fallback commands-raw-discrete-path-effect-fallback commands-vertices commands-blend-mode commands-graphics-layer commands-graphics-layer-modulate-alpha commands-graphics-layer-offscreen commands-graphics-layer-clip commands-graphics-layer-round-clip commands-graphics-layer-path-clip commands-graphics-layer-blend-mode commands-graphics-layer-color-filter commands-graphics-layer-color-matrix-filter commands-resize-graphics-layer-color-matrix-filter commands-forced-context-graphics-layer-color-matrix-filter commands-graphics-layer-raw-color-filter-fallback commands-graphics-layer-render-effect commands-resize-graphics-layer-render-effect commands-forced-context-graphics-layer-render-effect commands-graphics-layer-raw-image-filter-effect-fallback commands-graphics-layer-offset-effect commands-graphics-layer-chained-render-effect commands-graphics-layer-render-effect-color-filter commands-graphics-layer-render-effect-blend-mode commands-graphics-layer-render-effect-color-matrix-filter commands-graphics-layer-render-effect-blend-color-filter commands-graphics-layer-render-effect-blend-color-matrix-filter commands-graphics-layer-offset-effect-blend-color-matrix-filter commands-graphics-layer-chained-render-effect-blend-color-matrix-filter commands-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter commands-graphics-layer-shadow commands-graphics-layer-invalid-shadow-elevation-fallback commands-graphics-layer-round-shadow commands-graphics-layer-path-shadow commands-graphics-layer-rotationx commands-graphics-layer-rotationy commands-graphics-layer-rotationxy commands-graphics-layer-scale-translate commands-graphics-layer-near-camera commands-graphics-layer-offcenter-pivot commands-graphics-layer-blend-color-filter commands-graphics-layer-blend-color-matrix-filter commands-save-layer-filter commands-save-layer-raw-color-filter-fallback commands-opaque-shader-fallback commands-composite-opaque-shader-fallback commands-picture-shader-fallback commands-invalid-gradient-fallback}"
list_case_groups() {
  printf "%s\n" \
    smoke \
...
case_group_cases() {
  case "$1" in
    ...
    gradient-path-structure-invalid)
      ...
      ;;
    gradient-stop-invalid)
      echo "commands-linear-gradient-invalid-stops-fallback commands-radial-gradient-invalid-stops-fallback commands-invalid-gradient-fallback"
      ;;
    gradient-color-count-invalid)
    ...
    core-effects)
      ...
      ;;
    graphics-layer-extras)
      echo "commands-resize-graphics-layer-color-matrix-filter commands-forced-context-graphics-layer-color-matrix-filter commands-graphics-layer-raw-color-filter-fallback commands-graphics-layer-raw-table-color-filter-fallback commands-resize-graphics-layer-render-effect commands-forced-context-graphics-layer-render-effect commands-graphics-layer-raw-image-filter-effect-fallback commands-graphics-layer-render-effect-color-filter commands-graphics-layer-render-effect-blend-mode commands-graphics-layer-render-effect-color-matrix-filter commands-graphics-layer-render-effect-blend-color-filter commands-graphics-layer-render-effect-blend-color-matrix-filter commands-graphics-layer-offset-effect-blend-color-matrix-filter commands-graphics-layer-chained-render-effect-blend-color-matrix-filter commands-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter"
      ;;
    save-layer-shader-fallbacks)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-vertices commands-blend-mode" "commands-vertices commands-vertices-raw-color-filter-fallback commands-invalid-draw-vertices-vertex-count-fallback commands-invalid-draw-vertices-max-vertex-count-fallback commands-invalid-draw-vertices-record-length-fallback commands-invalid-draw-vertices-vertex-mode-fallback commands-invalid-draw-vertices-blend-mode-fallback commands-invalid-draw-vertices-index-count-fallback commands-invalid-draw-vertices-max-index-count-fallback commands-blend-mode"
