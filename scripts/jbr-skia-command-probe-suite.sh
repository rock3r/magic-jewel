...
case_group_cases() {
  case "$1" in
    ...
    runtime-effect-invalid)
      echo "commands-runtime-effect-shader-source-hash-fallback commands-runtime-effect-shader-source-code-fallback commands-runtime-effect-shader-sksl-length-fallback commands-runtime-effect-shader-uniform-float-count-fallback commands-runtime-effect-shader-negative-uniform-float-count-fallback commands-runtime-effect-shader-child-count-fallback commands-runtime-effect-shader-negative-child-count-fallback commands-runtime-effect-shader-named-uniform-count-fallback commands-runtime-effect-shader-negative-named-uniform-count-fallback commands-runtime-effect-shader-named-child-count-fallback commands-runtime-effect-shader-negative-named-child-count-fallback commands-runtime-effect-shader-uniform-name-fallback commands-runtime-effect-shader-uniform-schema-float-count-fallback commands-runtime-effect-shader-uniform-schema-float-offset-fallback commands-runtime-effect-shader-uniform-schema-float-range-fallback commands-runtime-effect-shader-uniform-schema-name-length-fallback commands-runtime-effect-shader-uniform-schema-max-name-length-fallback commands-runtime-effect-shader-uniform-schema-name-range-fallback commands-runtime-effect-shader-child-name-fallback commands-runtime-effect-shader-child-schema-name-length-fallback commands-runtime-effect-shader-child-schema-max-name-length-fallback commands-runtime-effect-shader-child-schema-name-range-fallback commands-runtime-effect-shader-child-index-fallback commands-runtime-effect-shader-negative-child-index-fallback commands-runtime-effect-color-filter-source-hash-fallback commands-runtime-effect-color-filter-source-code-fallback commands-runtime-effect-color-filter-sksl-length-fallback commands-runtime-effect-color-filter-uniform-float-count-fallback commands-runtime-effect-color-filter-negative-uniform-float-count-fallback commands-runtime-effect-color-filter-child-count-fallback commands-runtime-effect-color-filter-negative-child-count-fallback commands-runtime-effect-color-filter-named-uniform-count-fallback commands-runtime-effect-color-filter-negative-named-uniform-count-fallback commands-runtime-effect-color-filter-named-child-count-fallback commands-runtime-effect-color-filter-negative-named-child-count-fallback commands-runtime-effect-color-filter-uniform-name-fallback commands-runtime-effect-color-filter-uniform-schema-float-count-fallback commands-runtime-effect-color-filter-uniform-schema-float-offset-fallback commands-runtime-effect-color-filter-uniform-schema-float-range-fallback commands-runtime-effect-color-filter-uniform-schema-name-length-fallback commands-runtime-effect-color-filter-uniform-schema-max-name-length-fallback commands-runtime-effect-color-filter-uniform-schema-name-range-fallback commands-runtime-effect-color-filter-child-name-fallback commands-runtime-effect-color-filter-child-schema-name-length-fallback commands-runtime-effect-color-filter-child-schema-max-name-length-fallback commands-runtime-effect-color-filter-child-schema-name-range-fallback commands-runtime-effect-color-filter-child-index-fallback commands-runtime-effect-color-filter-negative-child-index-fallback commands-runtime-effect-invalid-uniform-schema-fallback commands-runtime-effect-invalid-child-schema-fallback commands-runtime-effect-invalid-nested-child-fallback commands-runtime-effect-color-filter-invalid-uniform-schema-fallback commands-runtime-effect-color-filter-invalid-child-schema-fallback commands-runtime-effect-color-filter-invalid-nested-child-fallback commands-runtime-effect-color-filter-compile-fallback commands-runtime-effect-color-filter-build-fallback commands-runtime-effect-color-filter-child-type-fallback commands-runtime-effect-compile-fallback commands-runtime-effect-build-fallback commands-runtime-effect-child-type-fallback"
      ;;
    descriptor-handles-invalid)
      echo "commands-invalid-descriptor-use-fallback commands-invalid-shader-descriptor-use-fallback commands-invalid-descriptor-use-after-evict-fallback commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback commands-invalid-path-effect-child-use-after-evict-fallback commands-runtime-effect-color-filter-child-missing-fallback commands-offset-image-filter-child-missing-fallback commands-chain-path-effect-child-missing-fallback commands-shader-color-filter-effect-child-missing-fallback commands-shader-wrong-effect-type-fallback commands-transformed-shader-child-wrong-effect-type-fallback commands-composite-shader-child-wrong-effect-type-fallback commands-runtime-effect-shader-child-wrong-effect-type-fallback commands-color-filter-wrong-effect-type-fallback commands-runtime-effect-color-filter-child-wrong-effect-type-fallback commands-color-filter-path-effect-wrong-type-fallback commands-shader-color-filter-wrong-effect-type-fallback commands-image-filter-wrong-effect-type-fallback commands-offset-image-filter-child-wrong-effect-type-fallback commands-chain-path-effect-child-wrong-effect-type-fallback"
      ;;
    color-filters)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  CASES="${CASES/commands-runtime-effect-invalid-uniform-schema-fallback/commands-runtime-effect-shader-source-hash-fallback commands-runtime-effect-shader-source-code-fallback commands-runtime-effect-shader-sksl-length-fallback commands-runtime-effect-shader-uniform-float-count-fallback commands-runtime-effect-shader-negative-uniform-float-count-fallback commands-runtime-effect-shader-child-count-fallback commands-runtime-effect-shader-negative-child-count-fallback commands-runtime-effect-shader-named-uniform-count-fallback commands-runtime-effect-shader-negative-named-uniform-count-fallback commands-runtime-effect-shader-named-child-count-fallback commands-runtime-effect-shader-negative-named-child-count-fallback commands-runtime-effect-shader-uniform-name-fallback commands-runtime-effect-shader-uniform-schema-float-count-fallback commands-runtime-effect-shader-uniform-schema-float-offset-fallback commands-runtime-effect-shader-uniform-schema-float-range-fallback commands-runtime-effect-shader-uniform-schema-name-length-fallback commands-runtime-effect-shader-uniform-schema-max-name-length-fallback commands-runtime-effect-shader-uniform-schema-name-range-fallback commands-runtime-effect-shader-child-name-fallback commands-runtime-effect-shader-child-schema-name-length-fallback commands-runtime-effect-shader-child-schema-max-name-length-fallback commands-runtime-effect-shader-child-schema-name-range-fallback commands-runtime-effect-shader-child-index-fallback commands-runtime-effect-shader-negative-child-index-fallback commands-runtime-effect-color-filter-source-hash-fallback commands-runtime-effect-color-filter-source-code-fallback commands-runtime-effect-color-filter-sksl-length-fallback commands-runtime-effect-color-filter-uniform-float-count-fallback commands-runtime-effect-color-filter-negative-uniform-float-count-fallback commands-runtime-effect-color-filter-child-count-fallback commands-runtime-effect-color-filter-negative-child-count-fallback commands-runtime-effect-color-filter-named-uniform-count-fallback commands-runtime-effect-color-filter-negative-named-uniform-count-fallback commands-runtime-effect-color-filter-named-child-count-fallback commands-runtime-effect-color-filter-negative-named-child-count-fallback commands-runtime-effect-color-filter-uniform-name-fallback commands-runtime-effect-color-filter-uniform-schema-float-count-fallback commands-runtime-effect-color-filter-uniform-schema-float-offset-fallback commands-runtime-effect-color-filter-uniform-schema-float-range-fallback commands-runtime-effect-color-filter-uniform-schema-name-length-fallback commands-runtime-effect-color-filter-uniform-schema-max-name-length-fallback commands-runtime-effect-color-filter-uniform-schema-name-range-fallback commands-runtime-effect-color-filter-child-name-fallback commands-runtime-effect-color-filter-child-schema-name-length-fallback commands-runtime-effect-color-filter-child-schema-max-name-length-fallback commands-runtime-effect-color-filter-child-schema-name-range-fallback commands-runtime-effect-color-filter-child-index-fallback commands-runtime-effect-color-filter-negative-child-index-fallback commands-runtime-effect-invalid-uniform-schema-fallback}"
