...
case_group_cases() {
  case "$1" in
    ...
    blend-mode-invalid)
      ...
      ;;
    graphics-layer-invalid)
      echo "commands-graphics-layer-invalid-alpha-fallback commands-graphics-layer-invalid-scale-x-fallback commands-graphics-layer-invalid-camera-distance-fallback commands-graphics-layer-invalid-shadow-elevation-fallback"
      ;;
    graphics-layer)
