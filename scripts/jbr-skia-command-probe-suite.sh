...
case_group_cases() {
  case "$1" in
    ...
    effect-descriptor-invalid)
      ...
      ;;
    shader-descriptor-invalid)
      echo "commands-invalid-shader-descriptor-type-fallback commands-invalid-shader-descriptor-record-flags-fallback commands-invalid-shader-descriptor-payload-count-fallback commands-invalid-color-shader-descriptor-payload-count-fallback commands-invalid-shader-color-filter-descriptor-payload-count-fallback commands-invalid-shader-descriptor-record-length-fallback commands-invalid-transformed-shader-descriptor-payload-count-fallback commands-invalid-composite-shader-descriptor-blend-mode-fallback commands-invalid-linear-gradient-shader-descriptor-tile-mode-fallback commands-invalid-linear-gradient-shader-descriptor-stop-order-fallback commands-invalid-radial-gradient-shader-descriptor-radius-fallback commands-invalid-radial-gradient-shader-descriptor-tile-mode-fallback commands-invalid-radial-gradient-shader-descriptor-stop-order-fallback commands-invalid-sweep-gradient-shader-descriptor-color-count-fallback commands-invalid-sweep-gradient-shader-descriptor-stop-order-fallback commands-invalid-image-shader-descriptor-width-fallback commands-invalid-image-shader-descriptor-max-width-fallback commands-invalid-image-shader-descriptor-height-fallback commands-invalid-image-shader-descriptor-max-height-fallback commands-invalid-image-shader-descriptor-tile-mode-x-fallback commands-invalid-image-shader-descriptor-tile-mode-y-fallback commands-invalid-perlin-noise-shader-kind-fallback commands-invalid-perlin-noise-shader-frequency-fallback commands-invalid-perlin-noise-shader-octaves-fallback commands-invalid-perlin-noise-shader-zero-octaves-fallback commands-invalid-perlin-noise-shader-tile-size-fallback commands-invalid-perlin-noise-shader-tile-height-fallback commands-invalid-perlin-noise-shader-negative-tile-size-fallback commands-invalid-perlin-noise-shader-negative-tile-height-fallback commands-invalid-descriptor-version-fallback"
      ;;
    shader-ref-invalid)
    ...
    image-handles-invalid)
      ...
      ;;
    save-layer-invalid)
      echo "commands-invalid-save-layer-alpha-fallback commands-invalid-save-layer-record-flags-fallback commands-invalid-save-layer-color-filter-record-flags-fallback commands-invalid-save-layer-blend-mode-record-flags-fallback commands-invalid-save-layer-blend-color-filter-record-flags-fallback commands-invalid-save-layer-color-filter-record-length-fallback commands-invalid-save-layer-blend-mode-record-length-fallback commands-invalid-save-layer-blend-color-filter-record-length-fallback commands-invalid-save-layer-color-filter-ref-record-flags-fallback commands-invalid-save-layer-blend-color-filter-ref-record-flags-fallback commands-invalid-save-layer-image-filter-ref-record-flags-fallback commands-invalid-save-layer-color-filter-width-fallback commands-invalid-save-layer-color-filter-height-fallback commands-invalid-save-layer-color-filter-alpha-fallback commands-invalid-save-layer-blend-mode-width-fallback commands-invalid-save-layer-blend-mode-height-fallback commands-invalid-save-layer-blend-mode-alpha-fallback commands-invalid-save-layer-blend-color-filter-width-fallback commands-invalid-save-layer-blend-color-filter-height-fallback commands-invalid-save-layer-blend-color-filter-alpha-fallback commands-invalid-save-layer-color-filter-blend-mode-fallback commands-invalid-save-layer-blend-mode-fallback commands-invalid-save-layer-blend-color-filter-blend-mode-fallback commands-invalid-save-layer-image-filter-alpha-fallback commands-invalid-save-layer-image-filter-width-fallback commands-invalid-save-layer-image-filter-height-fallback commands-invalid-save-layer-color-filter-ref-width-fallback commands-invalid-save-layer-color-filter-ref-height-fallback commands-invalid-save-layer-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-width-fallback commands-invalid-save-layer-blend-color-filter-ref-height-fallback commands-invalid-save-layer-blend-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-blend-mode-fallback"
      ;;
    color-filters)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-raw-blend-color-filter-fallback commands-color-filter" "commands-raw-blend-color-filter-fallback commands-invalid-fill-rect-color-filter-blend-mode-fallback commands-invalid-fill-rect-color-filter-width-fallback commands-invalid-fill-rect-color-filter-height-fallback commands-invalid-fill-rect-color-filter-ref-width-fallback commands-invalid-fill-rect-color-filter-ref-height-fallback commands-color-filter"
  ...
  replace_default_case_segment "commands-save-layer-filter commands-save-layer-raw-color-filter-fallback" "commands-save-layer-filter commands-save-layer-blend-mode commands-invalid-save-layer-alpha-fallback commands-invalid-save-layer-record-flags-fallback commands-invalid-save-layer-color-filter-record-flags-fallback commands-invalid-save-layer-blend-mode-record-flags-fallback commands-invalid-save-layer-blend-color-filter-record-flags-fallback commands-invalid-save-layer-color-filter-record-length-fallback commands-invalid-save-layer-blend-mode-record-length-fallback commands-invalid-save-layer-blend-color-filter-record-length-fallback commands-invalid-save-layer-color-filter-ref-record-flags-fallback commands-invalid-save-layer-blend-color-filter-ref-record-flags-fallback commands-invalid-save-layer-image-filter-ref-record-flags-fallback commands-invalid-save-layer-color-filter-width-fallback commands-invalid-save-layer-color-filter-height-fallback commands-invalid-save-layer-color-filter-alpha-fallback commands-invalid-save-layer-blend-mode-width-fallback commands-invalid-save-layer-blend-mode-height-fallback commands-invalid-save-layer-blend-mode-alpha-fallback commands-invalid-save-layer-blend-color-filter-width-fallback commands-invalid-save-layer-blend-color-filter-height-fallback commands-invalid-save-layer-blend-color-filter-alpha-fallback commands-invalid-save-layer-color-filter-blend-mode-fallback commands-invalid-save-layer-blend-mode-fallback commands-invalid-save-layer-blend-color-filter-blend-mode-fallback commands-invalid-save-layer-image-filter-alpha-fallback commands-invalid-save-layer-image-filter-width-fallback commands-invalid-save-layer-image-filter-height-fallback commands-invalid-save-layer-color-filter-ref-width-fallback commands-invalid-save-layer-color-filter-ref-height-fallback commands-invalid-save-layer-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-width-fallback commands-invalid-save-layer-blend-color-filter-ref-height-fallback commands-invalid-save-layer-blend-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-blend-mode-fallback commands-save-layer-raw-color-filter-fallback"
  replace_default_case_segment "commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback" "commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-save-layer-color-filter-use-fallback commands-invalid-save-layer-blend-color-filter-use-fallback commands-invalid-save-layer-image-filter-use-fallback commands-invalid-save-layer-color-filter-use-after-evict-fallback commands-invalid-save-layer-blend-color-filter-use-after-evict-fallback commands-invalid-save-layer-image-filter-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback"
  ...
  replace_default_case_segment "commands-invalid-offset-image-filter-descriptor-delta-fallback commands-invalid-shader-descriptor-type-fallback" "commands-invalid-offset-image-filter-descriptor-delta-fallback commands-invalid-corner-path-effect-descriptor-radius-fallback commands-invalid-shader-descriptor-type-fallback"
  ...
  replace_default_case_segment "commands-image-filter-wrong-effect-type-fallback commands-offset-image-filter-child-wrong-effect-type-fallback" "commands-image-filter-wrong-effect-type-fallback commands-path-effect-wrong-effect-type-fallback commands-offset-image-filter-child-wrong-effect-type-fallback"
fi
