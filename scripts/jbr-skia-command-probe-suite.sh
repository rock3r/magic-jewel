...
CASES="${CASES:-commands-live-animation commands-native-bridge-load-library commands-core-primitives commands-point-lines commands-point-dots commands-concat-transform commands-skew-transform commands-gradient-surfaces commands-gradient-paths commands-popup commands-popup-window commands-menu commands-text-image commands-native-custom-font-text-image commands-native-generic-font-text commands-native-loaded-font-data-text commands-native-resource-font-text commands-native-system-font-text commands-resize-native-generic-font-text commands-resize-native-loaded-font-data-text commands-resize-native-resource-font-text commands-resize-native-system-font-text commands-forced-context-native-custom-font-text-image commands-forced-context-native-generic-font-text commands-forced-context-native-loaded-font-data-text commands-forced-context-native-resource-font-text commands-forced-context-native-system-font-text commands-forced-context-dynamic-images commands-image-shader commands-raw-image-shader-fallback commands-color-shader commands-gradient-shaders commands-noise-shader commands-turbulence-shader commands-raw-linear-gradient-shader-fallback commands-raw-radial-gradient-shader-fallback commands-raw-sweep-gradient-shader-fallback commands-raw-noise-shader-fallback commands-raw-turbulence-shader-fallback commands-image-shader-color-filter commands-composite-shader commands-composite-noise-shader commands-composite-shader-color-filter commands-transformed-shader commands-runtime-effect-shader commands-raw-runtime-effect-shader-fallback commands-runtime-effect-shader-color-filter commands-linear-gradient-shader-color-filter commands-runtime-effect-pure-color commands-runtime-effect-uniform-only commands-runtime-effect-child-only commands-runtime-effect-color-filter commands-runtime-effect-stable-color-filter commands-raw-runtime-effect-color-filter-fallback commands-runtime-effect-color-filter-child commands-runtime-effect-build-fallback commands-runtime-effect-child-type-fallback commands-invalid-descriptor-use-fallback commands-invalid-descriptor-use-after-evict-fallback commands-invalid-descriptor-version-fallback commands-gradient-stroke commands-image-filter commands-image-color-matrix-filter commands-raw-blend-color-filter-fallback commands-color-filter commands-color-filter-handle commands-color-matrix-filter commands-lighting-filter commands-descriptor-eviction commands-resize-descriptor-redefine commands-forced-context-descriptor-redefine commands-resize-shader-descriptor-redefine commands-forced-context-shader-descriptor-redefine commands-resize-color-shader-descriptor-redefine commands-forced-context-color-shader-descriptor-redefine commands-resize-noise-shader-descriptor-redefine commands-forced-context-noise-shader-descriptor-redefine commands-resize-turbulence-shader-descriptor-redefine commands-forced-context-turbulence-shader-descriptor-redefine commands-resize-composite-noise-shader-descriptor-redefine commands-forced-context-composite-noise-shader-descriptor-redefine commands-path-effect-fallback commands-raw-discrete-path-effect-fallback commands-vertices-fallback commands-blend-mode commands-graphics-layer commands-graphics-layer-modulate-alpha commands-graphics-layer-offscreen commands-graphics-layer-clip commands-graphics-layer-round-clip commands-graphics-layer-path-clip commands-graphics-layer-blend-mode commands-graphics-layer-color-filter commands-graphics-layer-color-matrix-filter commands-graphics-layer-render-effect commands-resize-graphics-layer-render-effect commands-forced-context-graphics-layer-render-effect commands-graphics-layer-raw-image-filter-effect-fallback commands-graphics-layer-offset-effect commands-graphics-layer-chained-render-effect commands-graphics-layer-render-effect-color-filter commands-graphics-layer-render-effect-blend-mode commands-graphics-layer-render-effect-color-matrix-filter commands-graphics-layer-render-effect-blend-color-filter commands-graphics-layer-render-effect-blend-color-matrix-filter commands-graphics-layer-offset-effect-blend-color-matrix-filter commands-graphics-layer-chained-render-effect-blend-color-matrix-filter commands-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter commands-graphics-layer-shadow commands-graphics-layer-round-shadow commands-graphics-layer-path-shadow commands-graphics-layer-rotationx commands-graphics-layer-rotationy commands-graphics-layer-rotationxy commands-graphics-layer-near-camera commands-graphics-layer-offcenter-pivot commands-graphics-layer-blend-color-filter commands-graphics-layer-blend-color-matrix-filter commands-save-layer-filter commands-opaque-shader-fallback commands-composite-opaque-shader-fallback commands-picture-shader-fallback commands-invalid-gradient-fallback}"
