...
case_group_cases() {
  case "$1" in
    ...
    core-effects)
      ...
      ;;
    graphics-layer-extras)
      echo "commands-resize-graphics-layer-color-matrix-filter commands-forced-context-graphics-layer-color-matrix-filter commands-graphics-layer-raw-color-filter-fallback commands-graphics-layer-raw-table-color-filter-fallback commands-graphics-layer-unsupported-child-fallback commands-resize-graphics-layer-render-effect commands-forced-context-graphics-layer-render-effect commands-graphics-layer-raw-image-filter-effect-fallback commands-resize-graphics-layer-offset-effect commands-forced-context-graphics-layer-offset-effect commands-resize-graphics-layer-chained-render-effect commands-forced-context-graphics-layer-chained-render-effect commands-resize-graphics-layer-render-effect-color-filter commands-forced-context-graphics-layer-render-effect-color-filter commands-resize-graphics-layer-render-effect-blend-mode commands-forced-context-graphics-layer-render-effect-blend-mode commands-graphics-layer-render-effect-color-filter commands-graphics-layer-render-effect-blend-mode commands-graphics-layer-render-effect-color-matrix-filter commands-resize-graphics-layer-render-effect-color-matrix-filter commands-forced-context-graphics-layer-render-effect-color-matrix-filter commands-graphics-layer-render-effect-blend-color-filter commands-resize-graphics-layer-render-effect-blend-color-filter commands-forced-context-graphics-layer-render-effect-blend-color-filter commands-graphics-layer-render-effect-blend-color-matrix-filter commands-graphics-layer-offset-effect-blend-color-matrix-filter commands-graphics-layer-chained-render-effect-blend-color-matrix-filter commands-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter"
      ;;
    save-layer-shader-fallbacks)
