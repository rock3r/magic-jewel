...
case_group_cases() {
  case "$1" in
    ...
    image-handles-invalid)
      echo "commands-invalid-image-use-fallback commands-invalid-image-use-after-evict-fallback commands-invalid-image-color-filter-use-fallback commands-invalid-image-color-filter-use-after-evict-fallback commands-invalid-image-color-filter-ref-use-fallback commands-invalid-image-color-filter-ref-use-after-evict-fallback"
      ;;
    color-filters)
