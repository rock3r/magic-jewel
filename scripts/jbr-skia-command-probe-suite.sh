...
case_group_cases() {
  case "$1" in
    smoke)
      ...
      ;;
    surface-transform-ui)
      echo "commands-native-bridge-load-library commands-point-lines commands-point-dots commands-concat-transform commands-skew-transform commands-gradient-surfaces commands-linear-gradient-blend-mode commands-gradient-paths commands-popup commands-popup-window commands-menu commands-text-image"
      ;;
    gradient-path-stroke-fallbacks)
    ...
    graphics-layer-extras)
      ...
      ;;
    save-layer-shader-fallbacks)
      echo "commands-save-layer-filter commands-save-layer-blend-mode commands-save-layer-raw-color-filter-fallback commands-save-layer-raw-table-color-filter-fallback commands-opaque-shader-fallback commands-composite-opaque-shader-fallback commands-picture-shader-fallback commands-invalid-gradient-fallback"
      ;;
    stream-invalid)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-gradient-paths commands-linear-gradient-path-stroke-fallback" "commands-gradient-paths commands-linear-gradient-path-invalid-fallback commands-radial-gradient-path-invalid-fallback commands-sweep-gradient-path-invalid-fallback commands-linear-gradient-path-stroke-fallback"
