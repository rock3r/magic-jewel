...
case_group_cases() {
  case "$1" in
    smoke)
      ...
      ;;
    stream-invalid)
      echo "commands-invalid-command-stream-flags-fallback commands-invalid-command-record-flags-fallback commands-invalid-command-coordinate-space-fallback commands-invalid-command-paint-format-fallback"
      ;;
    path-invalid)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  CASES="${CASES/commands-raw-blend-color-filter-fallback commands-color-filter/commands-raw-blend-color-filter-fallback commands-invalid-fill-rect-color-filter-blend-mode-fallback commands-invalid-fill-rect-color-filter-width-fallback commands-invalid-fill-rect-color-filter-height-fallback commands-color-filter}"
  CASES="${CASES/commands-blend-mode commands-graphics-layer/commands-blend-mode commands-invalid-fill-rect-blend-mode-width-fallback commands-invalid-fill-rect-blend-mode-height-fallback commands-graphics-layer}"
