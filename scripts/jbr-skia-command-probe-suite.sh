...
case_group_cases() {
  case "$1" in
    ...
    image-handles-invalid)
      echo "commands-invalid-image-use-fallback commands-invalid-image-use-after-evict-fallback commands-invalid-image-ref-width-fallback commands-invalid-image-color-filter-use-fallback commands-invalid-image-color-filter-use-after-evict-fallback commands-invalid-image-color-filter-ref-use-fallback commands-invalid-image-color-filter-ref-use-after-evict-fallback"
      ;;
    color-filters)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  CASES="${CASES/commands-core-primitives commands-point-lines/commands-core-primitives commands-invalid-image-use-fallback commands-invalid-image-use-after-evict-fallback commands-invalid-image-ref-width-fallback commands-invalid-clip-path-verb-fallback commands-invalid-draw-path-verb-fallback commands-invalid-draw-path-path-effect-verb-fallback commands-invalid-stroke-path-dash-path-effect-verb-fallback commands-invalid-draw-shadow-path-verb-fallback commands-point-lines}"
  ...
  CASES="${CASES/commands-image-filter commands-image-color-matrix-filter/commands-image-filter commands-invalid-image-color-filter-use-fallback commands-invalid-image-color-filter-use-after-evict-fallback commands-invalid-image-color-filter-ref-use-fallback commands-invalid-image-color-filter-ref-use-after-evict-fallback commands-image-color-matrix-filter}"
