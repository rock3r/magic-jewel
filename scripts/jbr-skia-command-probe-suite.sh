...
if [[ -z "${CASES_WAS_SET}" ]]; then
  ...
  CASES="${CASES/commands-invalid-corner-path-effect-descriptor-radius-fallback commands-invalid-shader-descriptor-type-fallback/commands-invalid-corner-path-effect-descriptor-radius-fallback commands-invalid-stamped-path-effect-descriptor-advance-fallback commands-invalid-stamped-path-effect-descriptor-zero-advance-fallback commands-invalid-stamped-path-effect-descriptor-phase-fallback commands-invalid-stamped-path-effect-descriptor-style-fallback commands-invalid-stamped-path-effect-descriptor-fill-type-fallback commands-invalid-stamped-path-effect-descriptor-path-data-length-fallback commands-invalid-shader-descriptor-type-fallback}"
