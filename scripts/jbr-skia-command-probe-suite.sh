...
case_group_cases() {
  case "$1" in
    ...
    stream-invalid)
      ...
      ;;
    primitive-invalid)
      echo "commands-invalid-stroke-cap-fallback commands-invalid-transform-record-flags-fallback commands-invalid-clip-operation-fallback commands-invalid-draw-points-point-count-fallback commands-invalid-draw-points-record-length-fallback commands-invalid-draw-vertices-vertex-count-fallback commands-invalid-draw-vertices-record-length-fallback commands-invalid-draw-vertices-vertex-mode-fallback commands-invalid-draw-vertices-blend-mode-fallback"
      ;;
    path-invalid)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-vertices commands-blend-mode" "commands-vertices commands-invalid-draw-vertices-vertex-count-fallback commands-invalid-draw-vertices-record-length-fallback commands-invalid-draw-vertices-vertex-mode-fallback commands-invalid-draw-vertices-blend-mode-fallback commands-blend-mode"
