...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-color-shader commands-descriptor-stroke-shader-fallback" "commands-color-shader commands-resize-color-shader commands-forced-context-color-shader commands-color-shader-blend-mode commands-descriptor-stroke-shader-fallback"
