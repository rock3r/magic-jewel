...
case_group_cases() {
  case "$1" in
    ...
    image-handles-invalid)
      ...
      ;;
    save-layer-invalid)
      echo "commands-invalid-save-layer-alpha-fallback commands-invalid-save-layer-record-flags-fallback commands-invalid-save-layer-color-filter-record-flags-fallback commands-invalid-save-layer-blend-mode-record-flags-fallback commands-invalid-save-layer-blend-color-filter-record-flags-fallback commands-invalid-save-layer-color-filter-ref-record-flags-fallback commands-invalid-save-layer-blend-color-filter-ref-record-flags-fallback commands-invalid-save-layer-image-filter-ref-record-flags-fallback commands-invalid-save-layer-color-filter-width-fallback commands-invalid-save-layer-color-filter-height-fallback commands-invalid-save-layer-blend-mode-width-fallback commands-invalid-save-layer-blend-mode-height-fallback commands-invalid-save-layer-color-filter-blend-mode-fallback commands-invalid-save-layer-blend-mode-fallback commands-invalid-save-layer-blend-color-filter-blend-mode-fallback commands-invalid-save-layer-image-filter-alpha-fallback commands-invalid-save-layer-image-filter-width-fallback commands-invalid-save-layer-image-filter-height-fallback commands-invalid-save-layer-color-filter-ref-width-fallback commands-invalid-save-layer-color-filter-ref-height-fallback commands-invalid-save-layer-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-width-fallback commands-invalid-save-layer-blend-color-filter-ref-height-fallback commands-invalid-save-layer-blend-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-blend-mode-fallback"
      ;;
    color-filters)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-save-layer-filter commands-save-layer-raw-color-filter-fallback" "commands-save-layer-filter commands-save-layer-blend-mode commands-invalid-save-layer-alpha-fallback commands-invalid-save-layer-record-flags-fallback commands-invalid-save-layer-color-filter-record-flags-fallback commands-invalid-save-layer-blend-mode-record-flags-fallback commands-invalid-save-layer-blend-color-filter-record-flags-fallback commands-invalid-save-layer-color-filter-ref-record-flags-fallback commands-invalid-save-layer-blend-color-filter-ref-record-flags-fallback commands-invalid-save-layer-image-filter-ref-record-flags-fallback commands-invalid-save-layer-color-filter-width-fallback commands-invalid-save-layer-color-filter-height-fallback commands-invalid-save-layer-blend-mode-width-fallback commands-invalid-save-layer-blend-mode-height-fallback commands-invalid-save-layer-color-filter-blend-mode-fallback commands-invalid-save-layer-blend-mode-fallback commands-invalid-save-layer-blend-color-filter-blend-mode-fallback commands-invalid-save-layer-image-filter-alpha-fallback commands-invalid-save-layer-image-filter-width-fallback commands-invalid-save-layer-image-filter-height-fallback commands-invalid-save-layer-color-filter-ref-width-fallback commands-invalid-save-layer-color-filter-ref-height-fallback commands-invalid-save-layer-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-width-fallback commands-invalid-save-layer-blend-color-filter-ref-height-fallback commands-invalid-save-layer-blend-color-filter-ref-alpha-fallback commands-invalid-save-layer-blend-color-filter-ref-blend-mode-fallback commands-save-layer-raw-color-filter-fallback"
