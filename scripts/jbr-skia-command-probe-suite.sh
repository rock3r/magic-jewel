...
case_group_cases() {
  case "$1" in
    smoke)
      ...
      ;;
    stream-invalid)
      echo "commands-invalid-command-stream-flags-fallback commands-invalid-command-record-flags-fallback"
      ;;
    path-invalid)
