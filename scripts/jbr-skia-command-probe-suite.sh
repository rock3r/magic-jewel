...
case_group_cases() {
  case "$1" in
    smoke)
      ...
      ;;
    path-invalid)
      echo "commands-invalid-clip-path-verb-fallback commands-invalid-draw-path-verb-fallback commands-invalid-draw-path-path-effect-verb-fallback"
      ;;
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  CASES="${CASES/commands-core-primitives commands-point-lines/commands-core-primitives commands-invalid-clip-path-verb-fallback commands-invalid-draw-path-verb-fallback commands-invalid-draw-path-path-effect-verb-fallback commands-point-lines}"
