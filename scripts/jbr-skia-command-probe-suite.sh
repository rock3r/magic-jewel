...
case_group_cases() {
  case "$1" in
    ...
    color-filters)
      ...
      ;;
    descriptor-lifecycle)
      echo "commands-descriptor-eviction commands-resize-descriptor-redefine commands-forced-context-descriptor-redefine commands-resize-shader-descriptor-redefine commands-forced-context-shader-descriptor-redefine commands-resize-color-shader-descriptor-redefine commands-forced-context-color-shader-descriptor-redefine commands-resize-noise-shader-descriptor-redefine commands-forced-context-noise-shader-descriptor-redefine commands-resize-turbulence-shader-descriptor-redefine commands-forced-context-turbulence-shader-descriptor-redefine commands-resize-composite-noise-shader-descriptor-redefine commands-forced-context-composite-noise-shader-descriptor-redefine commands-runtime-effect-stable-color-filter commands-resize-runtime-effect-shader commands-forced-context-runtime-effect-shader commands-resize-runtime-effect-pure-color commands-forced-context-runtime-effect-pure-color commands-resize-runtime-effect-uniform-only commands-forced-context-runtime-effect-uniform-only commands-resize-runtime-effect-child-only commands-forced-context-runtime-effect-child-only commands-resize-runtime-effect-color-filter commands-forced-context-runtime-effect-color-filter commands-resize-runtime-effect-color-filter-child commands-forced-context-runtime-effect-color-filter-child commands-resize-runtime-effect-stable-color-filter commands-forced-context-runtime-effect-stable-color-filter commands-runtime-effect-shader-source-cache-eviction commands-runtime-effect-source-cache-eviction"
      ;;
    fill-rect-color-filter-invalid)
