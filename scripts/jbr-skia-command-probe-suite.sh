...
CASES="${CASES:-commands-live-animation commands-core-primitives commands-gradient-surfaces commands-gradient-paths commands-popup commands-popup-window commands-menu commands-text-image commands-native-text commands-image-shader commands-composite-shader commands-runtime-effect-shader commands-runtime-effect-pure-color commands-runtime-effect-uniform-only commands-runtime-effect-child-only commands-runtime-effect-build-fallback commands-gradient-stroke commands-image-filter commands-image-color-matrix-filter commands-color-filter-fallback commands-color-filter-handle commands-color-matrix-filter commands-lighting-filter commands-descriptor-eviction commands-resize-descriptor-redefine commands-path-effect-fallback commands-blend-mode commands-graphics-layer commands-graphics-layer-clip commands-graphics-layer-round-clip commands-graphics-layer-path-clip commands-graphics-layer-blend-mode commands-graphics-layer-color-filter commands-graphics-layer-color-matrix-filter commands-graphics-layer-render-effect commands-graphics-layer-offset-effect commands-graphics-layer-chained-render-effect commands-graphics-layer-blend-color-filter commands-graphics-layer-blend-color-matrix-filter commands-save-layer-filter commands-invalid-gradient-fallback}"
