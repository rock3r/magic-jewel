...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-noise-shader commands-turbulence-shader" "commands-noise-shader commands-resize-noise-shader commands-forced-context-noise-shader commands-turbulence-shader"
