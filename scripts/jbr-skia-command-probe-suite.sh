...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback" "commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-save-layer-color-filter-use-fallback commands-invalid-save-layer-blend-color-filter-use-fallback commands-invalid-save-layer-image-filter-use-fallback commands-invalid-save-layer-color-filter-use-after-evict-fallback commands-invalid-save-layer-blend-color-filter-use-after-evict-fallback commands-invalid-save-layer-image-filter-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback commands-invalid-blur-effect-child-use-after-evict-fallback"
