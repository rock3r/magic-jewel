...
case_group_cases() {
  case "$1" in
    ...
    stream-invalid)
      ...
      ;;
    primitive-invalid)
      echo "commands-invalid-stroke-cap-fallback commands-invalid-transform-record-flags-fallback commands-invalid-clip-operation-fallback commands-invalid-draw-points-point-count-fallback commands-invalid-draw-points-record-length-fallback"
      ;;
    path-invalid)
