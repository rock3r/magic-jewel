...
case_group_cases() {
  case "$1" in
    ...
    descriptor-handles-invalid)
      echo "commands-invalid-descriptor-use-fallback commands-invalid-shader-descriptor-use-fallback commands-invalid-descriptor-use-after-evict-fallback commands-invalid-color-filter-descriptor-use-after-evict-fallback commands-invalid-effect-child-use-after-evict-fallback commands-invalid-path-effect-child-use-after-evict-fallback commands-runtime-effect-color-filter-child-missing-fallback commands-offset-image-filter-child-missing-fallback commands-chain-path-effect-child-missing-fallback commands-shader-color-filter-effect-child-missing-fallback commands-shader-wrong-effect-type-fallback commands-transformed-shader-child-wrong-effect-type-fallback commands-composite-shader-child-wrong-effect-type-fallback commands-runtime-effect-shader-child-wrong-effect-type-fallback commands-color-filter-wrong-effect-type-fallback commands-runtime-effect-color-filter-child-wrong-effect-type-fallback commands-color-filter-path-effect-wrong-type-fallback commands-shader-color-filter-wrong-effect-type-fallback commands-image-filter-wrong-effect-type-fallback commands-blur-image-filter-child-wrong-effect-type-fallback commands-offset-image-filter-child-wrong-effect-type-fallback commands-chain-path-effect-child-wrong-effect-type-fallback"
      ;;
    color-filters)
