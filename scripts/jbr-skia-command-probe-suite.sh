...
case_group_cases() {
  case "$1" in
    ...
    runtime-effect-invalid)
      echo "commands-runtime-effect-shader-source-hash-fallback commands-runtime-effect-shader-sksl-length-fallback commands-runtime-effect-shader-uniform-float-count-fallback commands-runtime-effect-shader-negative-uniform-float-count-fallback commands-runtime-effect-shader-child-count-fallback commands-runtime-effect-shader-negative-child-count-fallback commands-runtime-effect-shader-named-uniform-count-fallback commands-runtime-effect-shader-named-child-count-fallback commands-runtime-effect-color-filter-sksl-length-fallback commands-runtime-effect-color-filter-uniform-float-count-fallback commands-runtime-effect-color-filter-negative-uniform-float-count-fallback commands-runtime-effect-color-filter-child-count-fallback commands-runtime-effect-color-filter-negative-child-count-fallback commands-runtime-effect-color-filter-named-uniform-count-fallback commands-runtime-effect-color-filter-negative-named-uniform-count-fallback commands-runtime-effect-color-filter-named-child-count-fallback commands-runtime-effect-color-filter-negative-named-child-count-fallback commands-runtime-effect-invalid-uniform-schema-fallback commands-runtime-effect-invalid-child-schema-fallback commands-runtime-effect-invalid-nested-child-fallback commands-runtime-effect-color-filter-invalid-uniform-schema-fallback commands-runtime-effect-color-filter-invalid-child-schema-fallback commands-runtime-effect-color-filter-invalid-nested-child-fallback commands-runtime-effect-color-filter-compile-fallback commands-runtime-effect-color-filter-build-fallback commands-runtime-effect-color-filter-child-type-fallback commands-runtime-effect-compile-fallback commands-runtime-effect-build-fallback commands-runtime-effect-child-type-fallback"
      ;;
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  CASES="${CASES/commands-runtime-effect-invalid-uniform-schema-fallback/commands-runtime-effect-shader-source-hash-fallback commands-runtime-effect-shader-sksl-length-fallback commands-runtime-effect-shader-uniform-float-count-fallback commands-runtime-effect-shader-negative-uniform-float-count-fallback commands-runtime-effect-shader-child-count-fallback commands-runtime-effect-shader-negative-child-count-fallback commands-runtime-effect-shader-named-uniform-count-fallback commands-runtime-effect-shader-named-child-count-fallback commands-runtime-effect-color-filter-sksl-length-fallback commands-runtime-effect-color-filter-uniform-float-count-fallback commands-runtime-effect-color-filter-negative-uniform-float-count-fallback commands-runtime-effect-color-filter-child-count-fallback commands-runtime-effect-color-filter-negative-child-count-fallback commands-runtime-effect-color-filter-named-uniform-count-fallback commands-runtime-effect-color-filter-negative-named-uniform-count-fallback commands-runtime-effect-color-filter-named-child-count-fallback commands-runtime-effect-color-filter-negative-named-child-count-fallback commands-runtime-effect-invalid-uniform-schema-fallback}"
