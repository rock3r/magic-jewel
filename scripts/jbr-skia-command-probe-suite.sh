...
case_group_cases() {
  case "$1" in
    ...
    image-shader-invalid)
      ...
      ;;
    shader-rendering)
      echo "commands-forced-context-dynamic-images commands-image-blend-mode commands-image-path-effect-fallback commands-image-shader commands-resize-image-shader commands-forced-context-image-shader commands-image-shader-blend-mode commands-image-shader-invalid-image-fallback commands-raw-image-shader-fallback commands-color-shader-blend-mode commands-descriptor-stroke-shader-fallback commands-gradient-shaders commands-noise-shader commands-turbulence-shader commands-raw-linear-gradient-shader-fallback commands-raw-radial-gradient-shader-fallback commands-raw-sweep-gradient-shader-fallback commands-raw-conical-gradient-shader-fallback commands-raw-noise-shader-fallback commands-raw-turbulence-shader-fallback"
      ;;
    shader-composition-runtime)
      echo "commands-image-shader-color-filter commands-resize-image-shader-color-filter commands-forced-context-image-shader-color-filter commands-composite-shader commands-resize-composite-shader-descriptor-redefine commands-forced-context-composite-shader-descriptor-redefine commands-composite-noise-shader commands-composite-shader-color-filter commands-transformed-shader commands-runtime-effect-shader commands-raw-runtime-effect-shader-fallback commands-runtime-effect-shader-color-filter commands-linear-gradient-shader-color-filter commands-radial-gradient-shader-color-filter commands-sweep-gradient-shader-color-filter commands-runtime-effect-pure-color commands-runtime-effect-uniform-only commands-runtime-effect-child-only commands-runtime-effect-color-filter commands-raw-runtime-effect-color-filter-fallback commands-runtime-effect-color-filter-child"
      ;;
    core-effects)
      echo "commands-gradient-stroke commands-image-filter commands-path-effect commands-path-effect-color-filter-fallback commands-raw-discrete-path-effect-fallback commands-vertices commands-vertices-raw-color-filter-fallback commands-blend-mode"
      ;;
    graphics-layer-extras)
      echo "commands-resize-graphics-layer-color-filter commands-forced-context-graphics-layer-color-filter commands-resize-graphics-layer-color-matrix-filter commands-forced-context-graphics-layer-color-matrix-filter commands-resize-graphics-layer-blend-color-filter commands-forced-context-graphics-layer-blend-color-filter commands-resize-graphics-layer-blend-color-matrix-filter commands-forced-context-graphics-layer-blend-color-matrix-filter commands-graphics-layer-raw-color-filter-fallback commands-graphics-layer-raw-table-color-filter-fallback commands-graphics-layer-unsupported-child-fallback commands-resize-graphics-layer-render-effect commands-forced-context-graphics-layer-render-effect commands-graphics-layer-raw-image-filter-effect-fallback commands-resize-graphics-layer-offset-effect commands-forced-context-graphics-layer-offset-effect commands-resize-graphics-layer-chained-render-effect commands-forced-context-graphics-layer-chained-render-effect commands-resize-graphics-layer-render-effect-color-filter commands-forced-context-graphics-layer-render-effect-color-filter commands-resize-graphics-layer-render-effect-blend-mode commands-forced-context-graphics-layer-render-effect-blend-mode commands-graphics-layer-render-effect-color-filter commands-graphics-layer-render-effect-blend-mode commands-graphics-layer-render-effect-color-matrix-filter commands-resize-graphics-layer-render-effect-color-matrix-filter commands-forced-context-graphics-layer-render-effect-color-matrix-filter commands-graphics-layer-render-effect-blend-color-filter commands-resize-graphics-layer-render-effect-blend-color-filter commands-forced-context-graphics-layer-render-effect-blend-color-filter commands-graphics-layer-render-effect-blend-color-matrix-filter commands-resize-graphics-layer-render-effect-blend-color-matrix-filter commands-forced-context-graphics-layer-render-effect-blend-color-matrix-filter commands-graphics-layer-offset-effect-blend-color-matrix-filter commands-resize-graphics-layer-offset-effect-blend-color-matrix-filter commands-forced-context-graphics-layer-offset-effect-blend-color-matrix-filter commands-graphics-layer-chained-render-effect-blend-color-matrix-filter commands-resize-graphics-layer-chained-render-effect-blend-color-matrix-filter commands-forced-context-graphics-layer-chained-render-effect-blend-color-matrix-filter commands-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter commands-resize-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter commands-forced-context-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter"
      ;;
    save-layer-shader-fallbacks)
    ...
    save-layer-invalid)
      ...
      ;;
    color-filters)
      echo "commands-image-color-matrix-filter commands-resize-image-color-matrix-filter commands-forced-context-image-color-matrix-filter commands-image-raw-table-color-filter-fallback commands-raw-blend-color-filter-fallback commands-raw-table-color-filter-fallback commands-color-filter commands-color-filter-blend-mode commands-color-filter-handle commands-color-matrix-filter commands-resize-color-matrix-filter commands-forced-context-color-matrix-filter commands-lighting-filter commands-resize-lighting-filter commands-forced-context-lighting-filter commands-graphics-layer-color-filter commands-resize-graphics-layer-color-filter commands-forced-context-graphics-layer-color-filter commands-graphics-layer-color-matrix-filter commands-graphics-layer-blend-color-filter commands-resize-graphics-layer-blend-color-filter commands-forced-context-graphics-layer-blend-color-filter commands-graphics-layer-blend-color-matrix-filter commands-resize-graphics-layer-blend-color-matrix-filter commands-forced-context-graphics-layer-blend-color-matrix-filter commands-save-layer-filter commands-resize-save-layer-filter commands-forced-context-save-layer-filter commands-save-layer-color-matrix-filter commands-resize-save-layer-color-matrix-filter commands-forced-context-save-layer-color-matrix-filter"
      ;;
    descriptor-lifecycle)
      echo "commands-descriptor-eviction commands-resize-descriptor-redefine commands-forced-context-descriptor-redefine commands-resize-shader-descriptor-redefine commands-forced-context-shader-descriptor-redefine commands-resize-color-shader-descriptor-redefine commands-forced-context-color-shader-descriptor-redefine commands-resize-noise-shader-descriptor-redefine commands-forced-context-noise-shader-descriptor-redefine commands-resize-turbulence-shader-descriptor-redefine commands-forced-context-turbulence-shader-descriptor-redefine commands-resize-composite-shader-descriptor-redefine commands-forced-context-composite-shader-descriptor-redefine commands-resize-composite-noise-shader-descriptor-redefine commands-forced-context-composite-noise-shader-descriptor-redefine commands-resize-composite-shader-color-filter commands-forced-context-composite-shader-color-filter commands-resize-transformed-shader commands-forced-context-transformed-shader commands-runtime-effect-stable-color-filter commands-resize-runtime-effect-shader commands-forced-context-runtime-effect-shader commands-resize-runtime-effect-shader-color-filter commands-forced-context-runtime-effect-shader-color-filter commands-resize-linear-gradient-shader-color-filter commands-forced-context-linear-gradient-shader-color-filter commands-resize-radial-gradient-shader-color-filter commands-forced-context-radial-gradient-shader-color-filter commands-resize-runtime-effect-pure-color commands-forced-context-runtime-effect-pure-color commands-resize-runtime-effect-uniform-only commands-forced-context-runtime-effect-uniform-only commands-resize-runtime-effect-child-only commands-forced-context-runtime-effect-child-only commands-resize-runtime-effect-color-filter commands-forced-context-runtime-effect-color-filter commands-resize-runtime-effect-color-filter-child commands-forced-context-runtime-effect-color-filter-child commands-resize-runtime-effect-stable-color-filter commands-forced-context-runtime-effect-stable-color-filter commands-resize-image-color-matrix-filter commands-forced-context-image-color-matrix-filter commands-resize-color-matrix-filter commands-forced-context-color-matrix-filter commands-resize-lighting-filter commands-forced-context-lighting-filter commands-resize-graphics-layer-blend-color-matrix-filter commands-forced-context-graphics-layer-blend-color-matrix-filter commands-resize-save-layer-color-matrix-filter commands-forced-context-save-layer-color-matrix-filter commands-runtime-effect-shader-source-cache-eviction commands-runtime-effect-source-cache-eviction"
      ;;
    fill-rect-color-filter-invalid)
...
if [[ -z "${CASES_WAS_SET}" && -z "${CASE_GROUPS}" ]]; then
  ...
  replace_default_case_segment "commands-color-shader commands-descriptor-stroke-shader-fallback" "commands-color-shader commands-color-shader-blend-mode commands-descriptor-stroke-shader-fallback"
  ...
  replace_default_case_segment "commands-composite-shader commands-composite-noise-shader" "commands-composite-shader commands-resize-composite-shader-descriptor-redefine commands-forced-context-composite-shader-descriptor-redefine commands-composite-noise-shader"
  replace_default_case_segment "commands-image-filter commands-image-color-matrix-filter" "commands-image-filter commands-invalid-image-color-filter-use-fallback commands-invalid-image-color-filter-use-after-evict-fallback commands-invalid-image-color-filter-ref-width-fallback commands-invalid-image-color-filter-ref-height-fallback commands-invalid-image-color-filter-ref-alpha-fallback commands-invalid-image-color-filter-ref-filter-quality-fallback commands-invalid-image-color-filter-blend-mode-fallback commands-invalid-image-color-filter-ref-use-fallback commands-invalid-image-color-filter-ref-use-after-evict-fallback commands-invalid-image-color-filter-descriptor-ref-width-fallback commands-invalid-image-color-filter-descriptor-ref-height-fallback commands-invalid-image-color-filter-descriptor-ref-alpha-fallback commands-invalid-image-color-filter-descriptor-ref-filter-quality-fallback commands-image-color-matrix-filter commands-resize-image-color-matrix-filter commands-forced-context-image-color-matrix-filter"
  ...
  replace_default_case_segment "commands-graphics-layer-near-camera commands-graphics-layer-offcenter-pivot" "commands-graphics-layer-near-camera commands-graphics-layer-invalid-camera-distance-fallback commands-graphics-layer-offcenter-pivot"
  ...
  case "$1" in
    ...
    commands-invalid-blend-layer-bounds-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=blendLayerBounds \
    ...
    commands-invalid-concat-transform-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=transform \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    ...
    commands-invalid-point-dots-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=points \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    ...
    commands-clip-path-invalid-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=clipPath \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-draw-path-invalid-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=path \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-invalid-draw-path-verb-fallback)
      run_case "$1" \
    ...
    commands-linear-gradient-invalid-stops-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=linearGradientStops \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-linear-gradient-invalid-points-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=linearGradientPoints \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-radial-gradient-invalid-stops-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=radialGradientStops \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-radial-gradient-invalid-geometry-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=radialGradientGeometry \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-linear-gradient-invalid-color-count-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=linearGradientColorCount \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-radial-gradient-invalid-color-count-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=radialGradientColorCount \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-sweep-gradient-invalid-color-count-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=sweepGradientColorCount \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-sweep-gradient-invalid-geometry-fallback)
      run_case "$1" \
    ...
    commands-linear-gradient-stroke-round-rect-invalid-radius-fallback)
      run_case "$1" \
        ...
        EXPECT_COMMAND_FALLBACK=true \
        EXPECT_COMMAND_FALLBACK_REASON=linearGradientStrokeRoundRectRadius \
        EXPECT_SCREENSHOT_ASSERTION=false
      ;;
    commands-radial-gradient-stroke-round-rect-invalid-radius-fallback)
      run_case "$1" \
