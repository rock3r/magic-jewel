...
case_group_cases() {
  case "$1" in
    ...
    save-layer-invalid)
      ...
      ;;
    color-filters)
      echo "commands-image-color-matrix-filter commands-image-raw-table-color-filter-fallback commands-raw-blend-color-filter-fallback commands-raw-table-color-filter-fallback commands-color-filter commands-color-filter-blend-mode commands-color-filter-handle commands-color-matrix-filter commands-lighting-filter commands-graphics-layer-color-filter commands-resize-graphics-layer-color-filter commands-forced-context-graphics-layer-color-filter commands-graphics-layer-color-matrix-filter commands-graphics-layer-blend-color-filter commands-resize-graphics-layer-blend-color-filter commands-forced-context-graphics-layer-blend-color-filter commands-graphics-layer-blend-color-matrix-filter commands-resize-graphics-layer-blend-color-matrix-filter commands-forced-context-graphics-layer-blend-color-matrix-filter"
      ;;
    descriptor-lifecycle)
      echo "commands-descriptor-eviction commands-resize-descriptor-redefine commands-forced-context-descriptor-redefine commands-resize-shader-descriptor-redefine commands-forced-context-shader-descriptor-redefine commands-resize-color-shader-descriptor-redefine commands-forced-context-color-shader-descriptor-redefine commands-resize-noise-shader-descriptor-redefine commands-forced-context-noise-shader-descriptor-redefine commands-resize-turbulence-shader-descriptor-redefine commands-forced-context-turbulence-shader-descriptor-redefine commands-resize-composite-noise-shader-descriptor-redefine commands-forced-context-composite-noise-shader-descriptor-redefine commands-resize-composite-shader-color-filter commands-forced-context-composite-shader-color-filter commands-resize-transformed-shader commands-forced-context-transformed-shader commands-runtime-effect-stable-color-filter commands-resize-runtime-effect-shader commands-forced-context-runtime-effect-shader commands-resize-runtime-effect-shader-color-filter commands-forced-context-runtime-effect-shader-color-filter commands-resize-linear-gradient-shader-color-filter commands-forced-context-linear-gradient-shader-color-filter commands-resize-radial-gradient-shader-color-filter commands-forced-context-radial-gradient-shader-color-filter commands-resize-runtime-effect-pure-color commands-forced-context-runtime-effect-pure-color commands-resize-runtime-effect-uniform-only commands-forced-context-runtime-effect-uniform-only commands-resize-runtime-effect-child-only commands-forced-context-runtime-effect-child-only commands-resize-runtime-effect-color-filter commands-forced-context-runtime-effect-color-filter commands-resize-runtime-effect-color-filter-child commands-forced-context-runtime-effect-color-filter-child commands-resize-runtime-effect-stable-color-filter commands-forced-context-runtime-effect-stable-color-filter commands-resize-graphics-layer-blend-color-matrix-filter commands-forced-context-graphics-layer-blend-color-matrix-filter commands-runtime-effect-shader-source-cache-eviction commands-runtime-effect-source-cache-eviction"
      ;;
    fill-rect-color-filter-invalid)
