...
case_group_cases() {
  case "$1" in
    ...
    shader-descriptor-invalid)
      ...
      ;;
    gradient-invalid)
      echo "commands-invalid-linear-gradient-stroke-width-fallback commands-invalid-linear-gradient-round-rect-stroke-width-fallback commands-invalid-radial-gradient-stroke-width-fallback commands-invalid-radial-gradient-round-rect-stroke-width-fallback commands-invalid-sweep-gradient-stroke-width-fallback commands-invalid-sweep-gradient-round-rect-stroke-width-fallback commands-invalid-linear-gradient-tile-mode-fallback commands-invalid-linear-gradient-round-rect-tile-mode-fallback commands-invalid-linear-gradient-stroke-tile-mode-fallback commands-invalid-linear-gradient-round-rect-stroke-tile-mode-fallback commands-invalid-linear-gradient-color-count-fallback commands-invalid-linear-gradient-round-rect-color-count-fallback commands-invalid-linear-gradient-stroke-color-count-fallback commands-invalid-linear-gradient-round-rect-stroke-color-count-fallback commands-invalid-linear-gradient-stop-order-fallback commands-invalid-linear-gradient-round-rect-stop-order-fallback commands-invalid-linear-gradient-stroke-stop-order-fallback commands-invalid-linear-gradient-round-rect-stroke-stop-order-fallback commands-invalid-sweep-gradient-color-count-fallback commands-invalid-sweep-gradient-round-rect-color-count-fallback commands-invalid-sweep-gradient-stroke-color-count-fallback commands-invalid-sweep-gradient-round-rect-stroke-color-count-fallback commands-invalid-radial-gradient-radius-fallback commands-invalid-radial-gradient-round-rect-radius-fallback commands-invalid-radial-gradient-stroke-radius-fallback commands-invalid-radial-gradient-round-rect-stroke-radius-fallback commands-invalid-radial-gradient-tile-mode-fallback commands-invalid-radial-gradient-round-rect-tile-mode-fallback commands-invalid-radial-gradient-stroke-tile-mode-fallback commands-invalid-radial-gradient-round-rect-stroke-tile-mode-fallback commands-invalid-radial-gradient-color-count-fallback commands-invalid-radial-gradient-round-rect-color-count-fallback commands-invalid-radial-gradient-stroke-color-count-fallback commands-invalid-radial-gradient-round-rect-stroke-color-count-fallback commands-invalid-radial-gradient-stop-order-fallback commands-invalid-radial-gradient-round-rect-stop-order-fallback commands-invalid-radial-gradient-stroke-stop-order-fallback commands-invalid-radial-gradient-round-rect-stroke-stop-order-fallback"
      ;;
