...
JEWEL_STANDALONE_SPECTRE_STRESS_MODE="${JEWEL_STANDALONE_SPECTRE_STRESS_MODE:-hypnotoad}"
JEWEL_STANDALONE_SPECTRE_COMPONENTS="${JEWEL_STANDALONE_SPECTRE_COMPONENTS:-}"
...
machine_snapshot() {
  {
    ...
    echo "spectre_stress_mode=${JEWEL_STANDALONE_SPECTRE_STRESS_MODE}"
    echo "spectre_components=${JEWEL_STANDALONE_SPECTRE_COMPONENTS}"
...
run_case() {
  ...
  env \
    ...
    JEWEL_STANDALONE_SPECTRE_STRESS_MODE="${JEWEL_STANDALONE_SPECTRE_STRESS_MODE}" \
    JEWEL_STANDALONE_SPECTRE_COMPONENTS="${JEWEL_STANDALONE_SPECTRE_COMPONENTS}" \
