...
MAX_COMPOSE_PARAGRAPH_PROBES_BAD_PIXEL_RATIO="${MAX_COMPOSE_PARAGRAPH_PROBES_BAD_PIXEL_RATIO:--1}"
...
MAX_COMPOSE_SHADER_COLOR_BAD_PIXEL_RATIO="${MAX_COMPOSE_SHADER_COLOR_BAD_PIXEL_RATIO:--1}"
...
MAX_COMPOSE_SHADER_NOISE_BAD_PIXEL_RATIO="${MAX_COMPOSE_SHADER_NOISE_BAD_PIXEL_RATIO:--1}"
MAX_COMPOSE_SHADER_TURBULENCE_BAD_PIXEL_RATIO="${MAX_COMPOSE_SHADER_TURBULENCE_BAD_PIXEL_RATIO:--1}"

/usr/bin/swift - "${OLD_IMAGE}" "${NEW_IMAGE}" "${MAX_AVG_DELTA}" "${MAX_BAD_PIXEL_RATIO}" "${BAD_PIXEL_THRESHOLD}" "${DIFF_IMAGE}" "${MAX_HEADER_CONTROLS_BAD_PIXEL_RATIO}" "${MAX_HEADER_BUTTONS_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_CANVAS_BAD_PIXEL_RATIO}" "${MAX_SWING_ISLAND_BAD_PIXEL_RATIO}" "${MAX_RIGHT_PROBE_STRIP_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_BACKDROP_LEFT_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_CENTER_ANIMATION_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_BOTTOM_LABELS_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_PARAGRAPH_PROBES_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_PURPLE_RECT_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_TOP_PROGRESS_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_BOTTOM_SWATCHES_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_SHADER_COLOR_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_SHADER_IMAGE_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_SHADER_COMPOSITE_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_SHADER_LINEAR_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_SHADER_NOISE_BAD_PIXEL_RATIO}" "${MAX_COMPOSE_SHADER_TURBULENCE_BAD_PIXEL_RATIO}" <<'SWIFT'
import CoreGraphics
import Foundation
import ImageIO
...
for (argumentIndex, regionName) in [
    ...
    (19, "composeShaderColor"),
    (20, "composeShaderImage"),
    (21, "composeShaderComposite"),
    (22, "composeShaderLinear"),
    (23, "composeShaderNoise"),
    (24, "composeShaderTurbulence"),
] {
...
do {
    ...
    let regions = [
        ...
        clampRegion(name: "composeParagraphProbes", x: 0.08, y: 0.52, width: 0.34, height: 0.22, imageWidth: compareWidth, imageHeight: compareHeight),
        ...
        clampRegion(name: "composeShaderColor", x: 0.793, y: 0.648, width: 0.057, height: 0.055, imageWidth: compareWidth, imageHeight: compareHeight),
        ...
        clampRegion(name: "composeShaderNoise", x: 0.60, y: 0.36, width: 0.10, height: 0.11, imageWidth: compareWidth, imageHeight: compareHeight),
        clampRegion(name: "composeShaderTurbulence", x: 0.60, y: 0.45, width: 0.10, height: 0.11, imageWidth: compareWidth, imageHeight: compareHeight),
